...
void kr_main() {
    kr_log_debug("This is a debug message");
    kr_log_info("This is an info message");
    kr_log_warn("This is a warning message");
    kr_log_error("This is an error message");
    kr_puts("All log stdlib tests passed!");
}
