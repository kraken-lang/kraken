...
static int64_t _kr_cl_43(void*, int64_t);
static int64_t _kr_cl_81(void*, int64_t);
static int64_t _kr_cl_122(void*, int64_t);
static int64_t _kr_cl_122(void* _env, int64_t x) {
    return x * 3;
}

static int64_t _kr_cl_81(void* _env, int64_t x) {
    return _KR_ADD(x, 10);
}

static int64_t _kr_cl_43(void* _env, int64_t x) {
    return x * 2;
}
...
int64_t kr_main() {
    void* double_val = (void*)(intptr_t)(_kr_cl_alloc((void*)_kr_cl_43, 0));
    kr_puts(kr_str_concat("double(5): ", kr_fmt_int((int64_t)(intptr_t)(((int64_t(*)(void*, int64_t))_KR_CL_FN(double_val))(_KR_CL_ENV(double_val), 5)))));
    int64_t result = kr_apply(_kr_cl_alloc((void*)_kr_cl_81, 0), 32);
    kr_puts(kr_str_concat("apply(+10, 32): ", kr_fmt_int((int64_t)(intptr_t)(result))));
    void* triple = (void*)(intptr_t)(_kr_cl_alloc((void*)_kr_cl_122, 0));
    kr_puts(kr_str_concat("triple(4): ", kr_fmt_int((int64_t)(intptr_t)(((int64_t(*)(void*, int64_t))_KR_CL_FN(triple))(_KR_CL_ENV(triple), 4)))));
    return 0;
}
