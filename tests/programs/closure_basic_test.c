...
void kr_apply(void* f, void* int_val, void* ,, int64_t ), void* return, void* ), void* main, void* int_val, void* :, int64_t ), void* |, int64_t |, void* return, void* ;, void* (, void* ,, void* ();
int64_t kr_(();

void kr_apply(void* f, void* int_val, void* ,, int64_t ), void* return, void* ), void* main, void* int_val, void* :, int64_t ), void* |, int64_t |, void* return, void* ;, void* (, void* ,, void* () {
    );
    int64_t result = kr_apply(|, :, |, int, return, +, ;, ,, ), kr_puts(kr_str_concat("apply(+10, 32): ", kr_fmt_int(result))), let, :, (int), int, |, :, |, int, return, *3, }, kr_puts(kr_str_concat("triple(4): ", kr_fmt_int(kr_triple(4)))), return, ;, );
}
