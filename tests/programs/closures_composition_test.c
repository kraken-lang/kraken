...
static int64_t _kr_cl_30(void*, int64_t);
static int64_t _kr_cl_72(void*, int64_t);
static int64_t _kr_cl_92(void*, int64_t);
static int64_t _kr_cl_110(void*, int64_t);
static int64_t _kr_cl_152(void*, int64_t);
static int64_t _kr_cl_170(void*, int64_t);
static int64_t _kr_cl_212(void*, int64_t);
static int64_t _kr_cl_230(void*, int64_t);
static int64_t _kr_cl_248(void*, int64_t);
static int64_t _kr_cl_295(void*, int64_t);
static int64_t _kr_cl_313(void*, int64_t);
static int64_t _kr_cl_331(void*, int64_t);
static int64_t _kr_cl_378(void*, int64_t);
static int64_t _kr_cl_394(void*, int64_t);
static int64_t _kr_cl_459(void*, int64_t);
static int64_t _kr_cl_477(void*, int64_t);
static int64_t _kr_cl_532(void*, int64_t);
static int64_t _kr_cl_556(void*, int64_t);
static int64_t _kr_cl_607(void*, int64_t);
static int64_t _kr_cl_649(void*, int64_t);
static int64_t _kr_cl_680(void*, int64_t);
static int64_t _kr_cl_744(void*, int64_t);
static kr_str _kr_cl_795(void*, int64_t);
static int64_t _kr_cl_811(void*, kr_str);
static int64_t _kr_cl_827(void*, int64_t);
static int64_t _kr_cl_868(void*, int64_t);
static int64_t _kr_cl_886(void*, int64_t);
static int64_t _kr_cl_904(void*, int64_t);
static int64_t _kr_cl_980(void*, int64_t);
static int64_t _kr_cl_1002(void*, int64_t);
static int64_t _kr_cl_1081(void*, int64_t);
static void* _kr_cl_1121(void*, int64_t);
static int64_t _kr_cl_1135(void*, int64_t);
static void* _kr_cl_1147(void*, int64_t, int64_t);
static int64_t _kr_cl_1208(void*, int64_t);
static int64_t _kr_cl_1223(void*, int64_t);
static int64_t _kr_cl_1238(void*, int64_t);
static int64_t _kr_cl_1253(void*, int64_t);
static int64_t _kr_cl_1273(void*, int64_t);
static bool _kr_cl_1348(void*, int64_t);
static int64_t _kr_cl_1366(void*, int64_t);
static int64_t _kr_cl_1399(void*, int64_t);
static int64_t _kr_cl_1462(void*, int64_t);
static int64_t _kr_cl_1495(void*, int64_t);
static int64_t _kr_cl_1495(void* _env, int64_t x) {
    return _KR_ADD(x, 10);
}

#define cached ((int64_t*)_env)[0]
#define kr_cached ((int64_t*)_env)[0]
#define cache ((int64_t*)_env)[1]
#define kr_cache ((int64_t*)_env)[1]
static int64_t _kr_cl_1462(void* _env, int64_t x) {
    if (!cached) {
        cache = x * x;
        cached = true;
    }
...
static int64_t _kr_cl_1399(void* _env, int64_t x) {
    return _KR_ADD(x, 1);
}

#define is_positive ((int64_t*)_env)[0]
#define kr_is_positive ((int64_t*)_env)[0]
static int64_t _kr_cl_1366(void* _env, int64_t x) {
    if (((int64_t(*)(void*, int64_t))_KR_CL_FN(is_positive))(_KR_CL_ENV(is_positive), x)) {
        return x * 2;
    }
    else {
        return x;
...
#undef is_positive
#undef kr_is_positive

static bool _kr_cl_1348(void* _env, int64_t x) {
    return x > 0;
}

#define operations ((int64_t*)_env)[0]
#define kr_operations ((int64_t*)_env)[0]
static int64_t _kr_cl_1273(void* _env, int64_t x) {
    __auto_type result = x;
    result = _kr_cl_call1((void*)kr_vec_int_get(operations, 0), result);
    result = _kr_cl_call1((void*)kr_vec_int_get(operations, 1), result);
    result = _kr_cl_call1((void*)kr_vec_int_get(operations, 2), result);
    result = _kr_cl_call1((void*)kr_vec_int_get(operations, 3), result);
    return result;
}
#undef operations
#undef kr_operations

static int64_t _kr_cl_1253(void* _env, int64_t x) {
    return x / 2;
}

static int64_t _kr_cl_1238(void* _env, int64_t x) {
    return x - 3;
}

static int64_t _kr_cl_1223(void* _env, int64_t x) {
    return x * 2;
}

static int64_t _kr_cl_1208(void* _env, int64_t x) {
    return _KR_ADD(x, 1);
}

#define make_adder ((int64_t*)_env)[0]
#define kr_make_adder ((int64_t*)_env)[0]
static void* _kr_cl_1147(void* _env, int64_t a, int64_t b) {
    return kr_compose(((int64_t(*)(void*, int64_t))_KR_CL_FN(make_adder))(_KR_CL_ENV(make_adder), a), ((int64_t(*)(void*, int64_t))_KR_CL_FN(make_adder))(_KR_CL_ENV(make_adder), b));
}
#undef make_adder
#undef kr_make_adder

#define n ((int64_t*)_env)[0]
#define kr_n ((int64_t*)_env)[0]
static int64_t _kr_cl_1135(void* _env, int64_t x) {
    return _KR_ADD(x, n);
}
#undef n
#undef kr_n

static void* _kr_cl_1121(void* _env, int64_t n) {
    return _kr_cl_alloc((void*)_kr_cl_1135, 1, (int64_t)n);
}

static int64_t _kr_cl_1081(void* _env, int64_t x) {
    return _KR_ADD(x, 1);
}

static int64_t _kr_cl_1002(void* _env, int64_t x) {
    return x * 2;
}

#define counter ((int64_t*)_env)[0]
#define kr_counter ((int64_t*)_env)[0]
static int64_t _kr_cl_980(void* _env, int64_t x) {
    counter = _KR_ADD(counter, 1);
    return x;
}
#undef counter
#undef kr_counter

static int64_t _kr_cl_904(void* _env, int64_t x) {
    return x - 3;
}
...
#define to_string ((int64_t*)_env)[0]
#define kr_to_string ((int64_t*)_env)[0]
#define get_length ((int64_t*)_env)[1]
#define kr_get_length ((int64_t*)_env)[1]
static int64_t _kr_cl_827(void* _env, int64_t x) {
    __auto_type s = ((int64_t(*)(void*, int64_t))_KR_CL_FN(to_string))(_KR_CL_ENV(to_string), x);
    return ((int64_t(*)(void*, int64_t))_KR_CL_FN(get_length))(_KR_CL_ENV(get_length), s);
}
#undef to_string
#undef kr_to_string
#undef get_length
...
static int64_t _kr_cl_811(void* _env, kr_str s) {
    return 5;
}

static kr_str _kr_cl_795(void* _env, int64_t x) {
    return "value";
}

#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_744(void* _env, int64_t y) {
    return _KR_ADD(x, y);
}
#undef x
#undef kr_x

static int64_t _kr_cl_680(void* _env, int64_t x) {
    return x * 2;
}

static int64_t _kr_cl_649(void* _env, int64_t x) {
    if (x < 0) {
        return -x;
    }
    else {
...
static int64_t _kr_cl_607(void* _env, int64_t x) {
    return x * 2;
}

#define n ((int64_t*)_env)[0]
#define kr_n ((int64_t*)_env)[0]
static int64_t _kr_cl_556(void* _env, int64_t x) {
    return x * n;
}
#undef n
#undef kr_n
...
#define n ((int64_t*)_env)[0]
#define kr_n ((int64_t*)_env)[0]
static int64_t _kr_cl_532(void* _env, int64_t x) {
    return _KR_ADD(x, n);
}
#undef n
#undef kr_n

static int64_t _kr_cl_477(void* _env, int64_t x) {
    return x * 2;
}

#define offset ((int64_t*)_env)[0]
#define kr_offset ((int64_t*)_env)[0]
static int64_t _kr_cl_459(void* _env, int64_t x) {
    return _KR_ADD(x, offset);
}
#undef offset
#undef kr_offset

static int64_t _kr_cl_394(void* _env, int64_t x) {
    return x * 2;
}

static int64_t _kr_cl_378(void* _env, int64_t x) {
    return x;
}

static int64_t _kr_cl_331(void* _env, int64_t x) {
    return x - 3;
}

static int64_t _kr_cl_313(void* _env, int64_t x) {
    return x * 2;
}

static int64_t _kr_cl_295(void* _env, int64_t x) {
    return _KR_ADD(x, 1);
}

static int64_t _kr_cl_248(void* _env, int64_t x) {
    return x - 3;
}

static int64_t _kr_cl_230(void* _env, int64_t x) {
    return x * 2;
}

static int64_t _kr_cl_212(void* _env, int64_t x) {
    return _KR_ADD(x, 1);
}

static int64_t _kr_cl_170(void* _env, int64_t x) {
    return _KR_ADD(x, 1);
}
...
static int64_t _kr_cl_110(void* _env, int64_t x) {
    return _KR_ADD(x, 1);
}

static int64_t _kr_cl_92(void* _env, int64_t x) {
    return x * 2;
}

#define g ((int64_t*)_env)[0]
#define kr_g ((int64_t*)_env)[0]
#define f ((int64_t*)_env)[1]
#define kr_f ((int64_t*)_env)[1]
static int64_t _kr_cl_72(void* _env, int64_t x) {
    return ((int64_t(*)(void*, int64_t))_KR_CL_FN(g))(_KR_CL_ENV(g), ((int64_t(*)(void*, int64_t))_KR_CL_FN(f))(_KR_CL_ENV(f), x));
}
#undef g
#undef kr_g
#undef f
...
static int64_t _kr_cl_30(void* _env, int64_t x) {
...
void* kr_curry_add(int64_t x);
void* kr_compose_twice(void* f);
void* kr_make_adder(int64_t n) {
    return _kr_cl_alloc((void*)_kr_cl_532, 1, (int64_t)n);
}

void* kr_make_multiplier(int64_t n) {
    return _kr_cl_alloc((void*)_kr_cl_556, 1, (int64_t)n);
}

void* kr_curry_add(int64_t x) {
    return _kr_cl_alloc((void*)_kr_cl_744, 1, (int64_t)x);
}
...
void* kr_compose(void* f, void* g) {
    return _kr_cl_alloc((void*)_kr_cl_30, 2, (int64_t)f, (int64_t)g);
}

void* kr_pipe(void* f, void* g) {
    return _kr_cl_alloc((void*)_kr_cl_72, 2, (int64_t)g, (int64_t)f);
}

void kr_test_basic_composition() {
    __auto_type double_val = _kr_cl_alloc((void*)_kr_cl_92, 0);
    __auto_type increment = _kr_cl_alloc((void*)_kr_cl_110, 0);
    __auto_type composed = kr_compose(double_val, increment);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed))(_KR_CL_ENV(composed), 5);
}

void kr_test_pipe_composition() {
    __auto_type double_val = _kr_cl_alloc((void*)_kr_cl_152, 0);
    __auto_type increment = _kr_cl_alloc((void*)_kr_cl_170, 0);
    __auto_type piped = kr_pipe(double_val, increment);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(piped))(_KR_CL_ENV(piped), 5);
}

void kr_test_triple_composition() {
    __auto_type f = _kr_cl_alloc((void*)_kr_cl_212, 0);
    __auto_type g = _kr_cl_alloc((void*)_kr_cl_230, 0);
    __auto_type h = _kr_cl_alloc((void*)_kr_cl_248, 0);
    __auto_type composed = kr_compose(f, kr_compose(g, h));
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed))(_KR_CL_ENV(composed), 10);
}

void kr_test_composition_chain() {
    __auto_type add1 = _kr_cl_alloc((void*)_kr_cl_295, 0);
    __auto_type mul2 = _kr_cl_alloc((void*)_kr_cl_313, 0);
    __auto_type sub3 = _kr_cl_alloc((void*)_kr_cl_331, 0);
    __auto_type chain = kr_compose(add1, kr_compose(mul2, sub3));
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(chain))(_KR_CL_ENV(chain), 10);
}

void kr_test_identity_composition() {
    __auto_type identity = _kr_cl_alloc((void*)_kr_cl_378, 0);
    __auto_type double_val = _kr_cl_alloc((void*)_kr_cl_394, 0);
    __auto_type composed1 = kr_compose(identity, double_val);
    __auto_type composed2 = kr_compose(double_val, identity);
    __auto_type r1 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed1))(_KR_CL_ENV(composed1), 5);
    __auto_type r2 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed2))(_KR_CL_ENV(composed2), 5);
}

void kr_test_composition_with_captures() {
    __auto_type offset = 10;
    __auto_type add_offset = _kr_cl_alloc((void*)_kr_cl_459, 1, (int64_t)offset);
    __auto_type double_val = _kr_cl_alloc((void*)_kr_cl_477, 0);
    __auto_type composed = kr_compose(add_offset, double_val);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed))(_KR_CL_ENV(composed), 5);
}

void kr_test_composition_factory() {
    __auto_type add5 = kr_make_adder(5);
    __auto_type mul3 = kr_make_multiplier(3);
    __auto_type composed = kr_compose(add5, mul3);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed))(_KR_CL_ENV(composed), 10);
}

void kr_test_self_composition() {
    __auto_type double_val = _kr_cl_alloc((void*)_kr_cl_607, 0);
    __auto_type quad = kr_compose(double_val, double_val);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(quad))(_KR_CL_ENV(quad), 5);
}

void kr_test_composition_with_conditionals() {
    __auto_type abs = _kr_cl_alloc((void*)_kr_cl_649, 0);
    __auto_type double_val = _kr_cl_alloc((void*)_kr_cl_680, 0);
    __auto_type composed = kr_compose(double_val, abs);
    __auto_type r1 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed))(_KR_CL_ENV(composed), -5);
    __auto_type r2 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed))(_KR_CL_ENV(composed), 5);
}

void kr_test_partial_application_composition() {
    __auto_type add5 = kr_curry_add(5);
    __auto_type add10 = kr_curry_add(10);
    __auto_type composed = kr_compose(add10, add5);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed))(_KR_CL_ENV(composed), 3);
}

void kr_test_composition_with_multiple_types() {
    __auto_type to_string = _kr_cl_alloc((void*)_kr_cl_795, 0);
    __auto_type get_length = _kr_cl_alloc((void*)_kr_cl_811, 0);
    __auto_type combined = _kr_cl_alloc((void*)_kr_cl_827, 2, (int64_t)to_string, (int64_t)get_length);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(combined))(_KR_CL_ENV(combined), 42);
}

void kr_test_composition_associativity() {
    __auto_type f = _kr_cl_alloc((void*)_kr_cl_868, 0);
    __auto_type g = _kr_cl_alloc((void*)_kr_cl_886, 0);
    __auto_type h = _kr_cl_alloc((void*)_kr_cl_904, 0);
    __auto_type left = kr_compose(kr_compose(f, g), h);
    __auto_type right = kr_compose(f, kr_compose(g, h));
    __auto_type r1 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(left))(_KR_CL_ENV(left), 10);
    __auto_type r2 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(right))(_KR_CL_ENV(right), 10);
}

void kr_test_composition_with_state() {
    __auto_type counter = 0;
    __auto_type increment_counter = _kr_cl_alloc((void*)_kr_cl_980, 1, (int64_t)counter);
    __auto_type double_val = _kr_cl_alloc((void*)_kr_cl_1002, 0);
    __auto_type composed = kr_compose(increment_counter, double_val);
    __auto_type r1 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed))(_KR_CL_ENV(composed), 5);
    __auto_type r2 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed))(_KR_CL_ENV(composed), 5);
}

void kr_test_higher_order_composition() {
    __auto_type increment = _kr_cl_alloc((void*)_kr_cl_1081, 0);
    __auto_type add2 = kr_compose_twice(increment);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add2))(_KR_CL_ENV(add2), 5);
}

void kr_test_composition_with_closures_returning_closures() {
    __auto_type make_adder = _kr_cl_alloc((void*)_kr_cl_1121, 0);
    __auto_type compose_adders = _kr_cl_alloc((void*)_kr_cl_1147, 1, (int64_t)make_adder);
    __auto_type add15 = ((int64_t(*)(void*, int64_t, int64_t))_KR_CL_FN(compose_adders))(_KR_CL_ENV(compose_adders), 5, 10);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add15))(_KR_CL_ENV(add15), 3);
}

void kr_test_composition_pipeline() {
    __auto_type operations = _kr_vec_int_of(4, (int64_t)_kr_cl_alloc((void*)_kr_cl_1208, 0), (int64_t)_kr_cl_alloc((void*)_kr_cl_1223, 0), (int64_t)_kr_cl_alloc((void*)_kr_cl_1238, 0), (int64_t)_kr_cl_alloc((void*)_kr_cl_1253, 0));
    __auto_type pipeline = _kr_cl_alloc((void*)_kr_cl_1273, 1, (int64_t)operations);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(pipeline))(_KR_CL_ENV(pipeline), 10);
}

void kr_test_composition_with_filtering() {
    __auto_type is_positive = _kr_cl_alloc((void*)_kr_cl_1348, 0);
    __auto_type double_if_positive = _kr_cl_alloc((void*)_kr_cl_1366, 1, (int64_t)is_positive);
    __auto_type increment = _kr_cl_alloc((void*)_kr_cl_1399, 0);
    __auto_type composed = kr_compose(increment, double_if_positive);
    __auto_type r1 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed))(_KR_CL_ENV(composed), 5);
    __auto_type r2 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed))(_KR_CL_ENV(composed), -5);
}
...
void kr_test_composition_memoization_style() {
    __auto_type cache = 0;
    __auto_type cached = false;
    __auto_type expensive = _kr_cl_alloc((void*)_kr_cl_1462, 2, (int64_t)cached, (int64_t)cache);
    __auto_type add10 = _kr_cl_alloc((void*)_kr_cl_1495, 0);
    __auto_type composed = kr_compose(add10, expensive);
    __auto_type r1 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed))(_KR_CL_ENV(composed), 5);
    __auto_type r2 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed))(_KR_CL_ENV(composed), 6);
}
