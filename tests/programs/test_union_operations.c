...
int64_t kr_test_union_init();
int64_t kr_test_union_assignment();
int64_t kr_main();
...
int64_t kr_test_union_init() {
    Value v1 = (Value){.int_val = 42};
    Value v2 = (Value){.float_val = 3.14};
    Value v3 = (Value){.bool_val = true};
    return 0;
}

int64_t kr_test_union_assignment() {
    Value v = (Value){.int_val = 10};
    return 0;
}

int64_t kr_main() {
    int64_t result = kr_test_union_init();
    result = _KR_ADD(result, kr_test_union_assignment());
    return result;
}
