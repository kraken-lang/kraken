...
void kr_big_check(Big b) {
    kr_puts(kr_str_concat("a=", kr_fmt_int(b.a)));
    kr_puts(kr_str_concat("b=", kr_fmt_int(b.b)));
    kr_puts(kr_str_concat("e=", b.e));
    kr_vec_int_push(b.f, b.a);
    kr_vec_string_push(b.h, kr_fmt_int(b.a));
}
...
int64_t kr_main() {
    ...
    kr_big_check(x);
    kr_puts(kr_str_concat("vec_int len: ", kr_fmt_int(kr_vec_int_len(v))));
    kr_puts(kr_str_concat("vec_string len: ", kr_fmt_int(kr_vec_string_len(o))));
    __auto_type i = 0;
