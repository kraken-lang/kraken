...
Big kr_big_new(void* v, void* s, void* o);
Big kr_big_advance(Big b);
void kr_big_check(Big b);
int64_t kr_main();
...
Big kr_big_advance(Big b) {
    return (Big){.a = _KR_ADD(b.a, 1), .b = b.b, .c = b.c, .d = b.d, .e = b.e, .f = b.f, .g = b.g, .h = b.h};
}

void kr_big_check(Big b) {
    kr_puts(kr_str_concat("a=", kr_fmt_int((int64_t)(intptr_t)(b.a))));
    kr_puts(kr_str_concat("b=", kr_fmt_int((int64_t)(intptr_t)(b.b))));
    kr_puts(kr_str_concat("e=", b.e));
    kr_vec_int_push(b.f, b.a);
    kr_vec_string_push(b.h, kr_fmt_int((int64_t)(intptr_t)(b.a)));
}

int64_t kr_main() {
    void* v = (void*)(intptr_t)(kr_vec_int_new());
    void* s = (void*)(intptr_t)(kr_vec_string_new());
    void* o = (void*)(intptr_t)(kr_vec_string_new());
    Big x = kr_big_new(v, s, o);
    kr_puts("--- initial ---");
    kr_big_check(x);
    x = kr_big_advance(x);
    kr_puts("--- after advance 1 ---");
    kr_big_check(x);
    x = kr_big_advance(x);
    kr_puts("--- after advance 2 ---");
    kr_big_check(x);
    kr_puts(kr_str_concat("vec_int len: ", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_len(v)))));
    kr_puts(kr_str_concat("vec_string len: ", kr_fmt_int((int64_t)(intptr_t)(kr_vec_string_len(o)))));
    __auto_type i = 0;
    while (i < kr_vec_int_len(v)) {
        kr_puts(kr_str_concat("  v[", kr_str_concat(kr_fmt_int((int64_t)(intptr_t)(i)), kr_str_concat("]=", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(v, i)))))));
        i = _KR_ADD(i, 1);
    }
    kr_vec_int_free(v);
    kr_vec_string_free(s);
    kr_vec_string_free(o);
    return 0;
}
