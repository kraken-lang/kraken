...
int64_t kr_add_async(int64_t x, int64_t y);
...
int64_t kr_main() {
    __auto_type result = kr_block_on((void*)(intptr_t)(kr_add_async(3, 4)));
    kr_puts(kr_str_concat("result: ", kr_fmt_int((int64_t)(intptr_t)(result))));
    __auto_type val = kr_block_on((void*)(intptr_t)(kr_get_value()));
    kr_puts(kr_str_concat("done: ", kr_fmt_int((int64_t)(intptr_t)(val))));
    return 0;
}
