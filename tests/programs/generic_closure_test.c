...
static int64_t _kr_cl_50(void*, int64_t);
static int64_t _kr_cl_90(void*, int64_t);
static int64_t _kr_cl_124(void*, int64_t);
static int64_t _kr_cl_164(void*, int64_t);
static int64_t _kr_cl_237(void*, int64_t);
static int64_t _kr_cl_322(void*, int64_t, int64_t);
static int64_t _kr_cl_368(void*, int64_t, int64_t);
static int64_t _kr_cl_414(void*, int64_t);
static int64_t _kr_cl_419(void*, int64_t);
static int64_t _kr_cl_508(void*, int64_t);
static int64_t _kr_cl_555(void*, int64_t);
static int64_t _kr_cl_563(void*, int64_t);
static int64_t _kr_cl_630(void*, int64_t);
static int64_t _kr_cl_630(void* _env, int64_t x) {
    __auto_type temp = x * 2;
    __auto_type temp2 = _KR_ADD(temp, 5);
    return temp2;
}

static int64_t _kr_cl_563(void* _env, int64_t y) {
    return _KR_ADD(y, 1);
}

static int64_t _kr_cl_555(void* _env, int64_t x) {
    return x * 3;
}

#define data ((int64_t*)_env)[0]
#define kr_data ((int64_t*)_env)[0]
static int64_t _kr_cl_508(void* _env, int64_t x) {
    return _KR_ADD(x, data);
}
#undef data
#undef kr_data
...
static int64_t _kr_cl_419(void* _env, int64_t y) {
    return _KR_ADD(x, y);
}
#undef x
#undef kr_x

static int64_t _kr_cl_414(void* _env, int64_t x) {
    return _kr_cl_alloc((void*)_kr_cl_419, 1, (int64_t)x);
}

static int64_t _kr_cl_368(void* _env, int64_t x, int64_t y) {
    return x > y;
}

static int64_t _kr_cl_322(void* _env, int64_t x, int64_t y) {
    return _KR_ADD(x, y);
}

#define multiplier ((int64_t*)_env)[0]
#define kr_multiplier ((int64_t*)_env)[0]
static int64_t _kr_cl_237(void* _env, int64_t x) {
    return x * multiplier;
}
#undef multiplier
#undef kr_multiplier
...
static int64_t _kr_cl_164(void* _env, int64_t x) {
    return x * factor;
}
#undef factor
#undef kr_factor

static int64_t _kr_cl_124(void* _env, int64_t x) {
    return _KR_ADD(x, 5);
}

static int64_t _kr_cl_90(void* _env, int64_t x) {
    return x > 3;
}

static int64_t _kr_cl_50(void* _env, int64_t x) {
    return x * 2;
}

int64_t kr_apply(int64_t value, void* transform) {
    return ((int64_t(*)(void*, int64_t))_KR_CL_FN(transform))(_KR_CL_ENV(transform), value);
}

int64_t kr_test_apply_int_to_int() {
    __auto_type result = kr_apply(5, _kr_cl_alloc((void*)_kr_cl_50, 0));
...
int64_t kr_test_apply_int_to_bool() {
    __auto_type result = kr_apply(5, _kr_cl_alloc((void*)_kr_cl_90, 0));
    if (!result) {
        return 1;
    }
    return 0;
...
int64_t kr_test_apply_inference() {
    __auto_type result = kr_apply(10, _kr_cl_alloc((void*)_kr_cl_124, 0));
...
void* kr_make_multiplier(int64_t factor) {
    return _kr_cl_alloc((void*)_kr_cl_164, 1, (int64_t)factor);
}

int64_t kr_test_make_multiplier() {
    __auto_type times_three = kr_make_multiplier(3);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(times_three))(_KR_CL_ENV(times_three), 7);
...
int64_t kr_test_closure_capture_generic() {
    ...
    __auto_type result = kr_apply(5, _kr_cl_alloc((void*)_kr_cl_237, 1, (int64_t)multiplier));
...
int64_t kr_combine(int64_t a, int64_t b, void* combiner) {
    return ((int64_t(*)(void*, int64_t, int64_t))_KR_CL_FN(combiner))(_KR_CL_ENV(combiner), a, b);
}

int64_t kr_test_combine() {
    __auto_type result = kr_combine(3, 4, _kr_cl_alloc((void*)_kr_cl_322, 0));
    if (_KR_NEQ(result, 7)) {
        return 1;
    }
    return 0;
...
int64_t kr_test_combine_different_types() {
    __auto_type result = kr_combine(5, 3, _kr_cl_alloc((void*)_kr_cl_368, 0));
    if (!result) {
        return 1;
    }
    return 0;
...
int64_t kr_test_nested_closures() {
    __auto_type outer = kr_apply(2, _kr_cl_alloc((void*)_kr_cl_414, 0));
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(outer))(_KR_CL_ENV(outer), 3);
    if (_KR_NEQ(result, 5)) {
        return 1;
    }
    return 0;
...
int64_t kr_test_move_closure() {
    int64_t data = 10;
    __auto_type result = kr_apply_move(5, _kr_cl_alloc((void*)_kr_cl_508, 1, (int64_t)data));
    if (_KR_NEQ(result, 15)) {
        return 1;
    }
    return 0;
...
int64_t kr_test_chained_generic() {
    __auto_type result = kr_apply(kr_apply(2, _kr_cl_alloc((void*)_kr_cl_555, 0)), _kr_cl_alloc((void*)_kr_cl_563, 0));
    if (_KR_NEQ(result, 7)) {
        return 1;
    }
    return 0;
...
int64_t kr_process(int64_t value, void* processor) {
    return ((int64_t(*)(void*, int64_t))_KR_CL_FN(processor))(_KR_CL_ENV(processor), value);
}

int64_t kr_test_complex_closure() {
    __auto_type result = kr_process(10, _kr_cl_alloc((void*)_kr_cl_630, 0));
...
int64_t kr_main() {
    int64_t failures = 0;
    failures = _KR_ADD(failures, kr_test_apply_int_to_int());
    failures = _KR_ADD(failures, kr_test_apply_int_to_bool());
    failures = _KR_ADD(failures, kr_test_apply_inference());
    failures = _KR_ADD(failures, kr_test_make_multiplier());
    failures = _KR_ADD(failures, kr_test_closure_capture_generic());
    failures = _KR_ADD(failures, kr_test_combine());
    failures = _KR_ADD(failures, kr_test_combine_different_types());
    failures = _KR_ADD(failures, kr_test_nested_closures());
    failures = _KR_ADD(failures, kr_test_move_closure());
    failures = _KR_ADD(failures, kr_test_chained_generic());
    failures = _KR_ADD(failures, kr_test_complex_closure());
    return failures;
}
