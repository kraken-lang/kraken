...
int64_t kr_main() {
    ...
    __auto_type trimmed1 = kr_str_trim(s1);
    if (_KR_NEQ(kr_str_len(trimmed1), 5)) {
        return 1;
    }
    __auto_type s2 = "\t\nhello\n\t";
    __auto_type trimmed2 = kr_str_trim(s2);
    if (_KR_NEQ(kr_str_len(trimmed2), 5)) {
        return 2;
    }
    __auto_type s3 = "   ";
    __auto_type trimmed3 = kr_str_trim(s3);
    if (_KR_NEQ(kr_str_len(trimmed3), 0)) {
        return 3;
    }
    __auto_type s4 = "hello";
    __auto_type trimmed4 = kr_str_trim(s4);
    if (_KR_NEQ(kr_str_len(trimmed4), 5)) {
        return 4;
    }
    return 0;
}
