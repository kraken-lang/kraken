...
Big kr_make_big(int64_t x);
int64_t kr_sum_big(Big s);
Big kr_modify_big(Big s);
void kr_use_vec_and_struct(void* v, Big s);
int64_t kr_main();
...
Big kr_make_big(int64_t x) {
    return (Big){.a = x, .b = _KR_ADD(x, 1), .c = _KR_ADD(x, 2), .d = _KR_ADD(x, 3), .e = _KR_ADD(x, 4)};
}

int64_t kr_sum_big(Big s) {
    return _KR_ADD(_KR_ADD(_KR_ADD(_KR_ADD(s.a, s.b), s.c), s.d), s.e);
}
...
void kr_use_vec_and_struct(void* v, Big s) {
    kr_vec_int_push(v, s.a);
    kr_vec_int_push(v, s.b);
}

int64_t kr_main() {
    Big s = kr_make_big(10);
    kr_puts(kr_fmt_int((int64_t)(intptr_t)(kr_sum_big(s))));
    Big s2 = kr_modify_big(s);
    kr_puts(kr_fmt_int((int64_t)(intptr_t)(kr_sum_big(s2))));
    void* v = (void*)(intptr_t)(kr_vec_int_new());
    kr_use_vec_and_struct(v, s);
    kr_puts(kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(v, 0))));
    kr_puts(kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(v, 1))));
    kr_vec_int_free(v);
    return 0;
}
