...
int64_t kr_main() {
    int64_t a = kr_identity(42);
    kr_puts(kr_str_concat("identity int: ", kr_fmt_int((int64_t)(intptr_t)(a))));
    kr_str b = (kr_str)(intptr_t)(kr_identity("hello"));
    kr_puts(kr_str_concat("identity str: ", b));
    int64_t c = kr_add_generic(10, 20);
    kr_puts(kr_str_concat("add_generic: ", kr_fmt_int((int64_t)(intptr_t)(c))));
    Pair p = (Pair){.first = 1, .second = 2};
    kr_puts(kr_str_concat("pair.first: ", kr_fmt_int((int64_t)(intptr_t)(p.first))));
    kr_puts(kr_str_concat("pair.second: ", kr_fmt_int((int64_t)(intptr_t)(p.second))));
    int64_t d = kr_identity(99);
    kr_puts(kr_str_concat("inferred identity: ", kr_fmt_int((int64_t)(intptr_t)(d))));
    return 0;
}
