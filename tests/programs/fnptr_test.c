...
void kr_main() {
    __auto_type ptr1 = ((void*)(intptr_t)(_kr_cl_alloc((void*)kr_main, 0)));
    kr_puts("Got main pointer!");
    kr_puts(kr_fmt_int((int64_t)(intptr_t)(ptr1)));
    __auto_type ptr2 = ((void*)(intptr_t)(_kr_cl_alloc((void*)kr_greet, 0)));
    kr_puts("Got greet pointer!");
    kr_puts(kr_fmt_int((int64_t)(intptr_t)(ptr2)));
}
