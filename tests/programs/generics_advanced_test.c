...
int64_t kr_test_pair() {
    ...
    KrTuple2 _kr_tup_60 = p;
    __auto_type x = _kr_tup_60.f0;
    __auto_type y = _kr_tup_60.f1;
    if (_KR_NEQ(x, 42)) {
        return 1;
    }
    if (!y) {
...
KrTuple2 kr_swap(KrTuple2 p) {
    KrTuple2 _kr_tup_452 = p;
    __auto_type a = _kr_tup_452.f0;
    __auto_type b = _kr_tup_452.f1;
    return (KrTuple2){.f0 = b, .f1 = a};
}

int64_t kr_test_swap() {
    __auto_type p1 = kr_pair(42, true);
    __auto_type p2 = kr_swap(p1);
    KrTuple2 _kr_tup_504 = p2;
    __auto_type b = _kr_tup_504.f0;
    __auto_type i = _kr_tup_504.f1;
    if (!b) {
        return 1;
    }
    if (_KR_NEQ(i, 42)) {
...
int64_t kr_max(int64_t a, int64_t b, void* compare) {
    if (((int64_t(*)(void*, int64_t, int64_t))_KR_CL_FN(compare))(_KR_CL_ENV(compare), a, b)) {
        return a;
    }
    else {
        return b;
...
int64_t kr_main() {
    ...
    failures = _KR_ADD(failures, kr_test_pair());
    ...
    failures = _KR_ADD(failures, kr_test_swap());
    failures = _KR_ADD(failures, kr_test_chained());
