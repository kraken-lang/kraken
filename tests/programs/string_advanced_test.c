...
int64_t kr_main() {
    ...
    __auto_type found = kr_strstr("Hello World", "World");
    __auto_type cmp1 = kr_strcmp((kr_str)(intptr_t)("abc"), (kr_str)(intptr_t)("abc"));
    __auto_type cmp2 = kr_strcmp((kr_str)(intptr_t)("abc"), (kr_str)(intptr_t)("xyz"));
    kr_puts("String tests complete!");
    return cmp1;
}
