...
int64_t kr_main() {
    int64_t result = 0;
    result = result + kr_test_sprintf();
    result = result + kr_test_snprintf();
    result = result + kr_test_strtok();
    result = result + kr_test_strdup();
    result = result + kr_test_strchr();
    result = result + kr_test_strrchr();
    return result;
}
