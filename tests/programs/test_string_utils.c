...
int64_t kr_test_sprintf();
int64_t kr_test_snprintf();
int64_t kr_test_strtok();
int64_t kr_test_strdup();
int64_t kr_test_strchr();
int64_t kr_test_strrchr();
int64_t kr_main();
...
int64_t kr_main() {
    int64_t result = 0;
    result = _KR_ADD(result, kr_test_sprintf());
    result = _KR_ADD(result, kr_test_snprintf());
    result = _KR_ADD(result, kr_test_strtok());
    result = _KR_ADD(result, kr_test_strdup());
    result = _KR_ADD(result, kr_test_strchr());
    result = _KR_ADD(result, kr_test_strrchr());
    return result;
}
