...
int64_t kr_main() {
    __auto_type s1 = "hello world";
    if (!kr_str_contains(s1, "world")) {
        return 1;
    }
    if (!kr_str_contains(s1, "hello")) {
        return 2;
    }
    if (!kr_str_contains(s1, "lo wo")) {
        return 3;
    }
    if (kr_str_contains(s1, "xyz")) {
        return 4;
    }
    if (!kr_str_contains(s1, "")) {
        return 5;
    }
    return 0;
}
