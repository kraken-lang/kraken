...
void kr_push_test(void* v, int64_t val);
int64_t kr_main();


void kr_push_test(void* v, int64_t val) {
    kr_vec_int_push(v, val);
}
...
int64_t kr_main() {
    ...
    kr_push_test(v, 42);
    kr_push_test(v, 99);
    __auto_type a = kr_vec_int_get(v, 0);
    __auto_type b = kr_vec_int_get(v, 1);
    kr_puts(kr_fmt_int((int64_t)(intptr_t)(a)));
    kr_puts(kr_fmt_int((int64_t)(intptr_t)(b)));
    kr_vec_int_free(v);
    return 0;
}
