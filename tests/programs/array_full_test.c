...
int64_t kr_main() {
    __auto_type arr = _kr_vec_int_of(3, (int64_t)10, (int64_t)20, (int64_t)30);
    return _KR_ADD(_KR_ADD(kr_vec_int_get(arr, 0), kr_vec_int_get(arr, 1)), kr_vec_int_get(arr, 2));
}
