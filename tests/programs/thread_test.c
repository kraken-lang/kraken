...
void kr_worker() {
    kr_puts("Worker thread running!");
}

void kr_main() {
    kr_puts("=== Thread Tests ===");
    ...
    __auto_type t = kr_thread_spawn(((void*)(intptr_t)(_kr_cl_alloc((void*)kr_worker, 0))));
    kr_thread_join(t);
    kr_puts("Thread spawn/join: PASS");
    kr_puts("All thread tests complete!");
}
