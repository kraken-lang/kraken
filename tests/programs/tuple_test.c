...
int64_t kr_main() {
    KrTuple2 pair = (KrTuple2){.f0 = 10, .f1 = 20};
    KrTuple3 triple = (KrTuple3){.f0 = 42, .f1 = "hello", .f2 = true};
    int64_t x = pair.f0;
    int64_t y = pair.f1;
    int64_t a = triple.f0;
    ...
    KrTuple2 nested = (KrTuple2){.f0 = ({KrTuple2 _t = (KrTuple2){.f0 = 1, .f1 = 2}; _kr_box(&_t, sizeof(KrTuple2));}), .f1 = ({KrTuple2 _t = (KrTuple2){.f0 = "test", .f1 = false}; _kr_box(&_t, sizeof(KrTuple2));})};
    KrTuple2 inner1 = *(KrTuple2*)(intptr_t)(nested.f0);
    KrTuple2 inner2 = *(KrTuple2*)(intptr_t)(nested.f1);
