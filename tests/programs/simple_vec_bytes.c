...
int64_t kr_main() {
    void* v = (void*)(intptr_t)(kr_vec_bytes_new());
    kr_vec_bytes_push(v, 65);
    kr_vec_bytes_push(v, 66);
    kr_vec_bytes_push(v, 67);
    __auto_type a = kr_vec_bytes_get(v, 0);
    __auto_type b = kr_vec_bytes_get(v, 1);
    __auto_type c = kr_vec_bytes_get(v, 2);
    kr_vec_bytes_free(v);
