...
void kr_main() {
    kr_puts("=== CondVar Tests ===");
    kr_puts("Testing condvar_create...");
    __auto_type cv = kr_condvar_create();
    kr_puts("condvar_create: PASS");
    __auto_type m = kr_mutex_create();
    kr_puts("Testing condvar_signal...");
    kr_condvar_signal(cv);
    kr_puts("condvar_signal: PASS");
    kr_puts("Testing condvar_broadcast...");
    kr_condvar_broadcast(cv);
    kr_puts("condvar_broadcast: PASS");
    kr_puts("Testing condvar_destroy...");
    kr_condvar_destroy(cv);
    kr_puts("condvar_destroy: PASS");
    kr_mutex_destroy(m);
    kr_puts("All condvar tests complete!");
}
