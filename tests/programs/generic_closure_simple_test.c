...
static int64_t _kr_cl_118(void*, int64_t);
static int64_t _kr_cl_158(void*, int64_t);
#define multiplier ((int64_t*)_env)[0]
#define kr_multiplier ((int64_t*)_env)[0]
static int64_t _kr_cl_158(void* _env, int64_t x) {
    return x * multiplier;
}
#undef multiplier
#undef kr_multiplier

static int64_t _kr_cl_118(void* _env, int64_t x) {
    return x * 2;
}
...
int64_t kr_test_higher_order() {
    __auto_type result = kr_apply_int(5, _kr_cl_alloc((void*)_kr_cl_118, 0));
...
int64_t kr_test_closure_capture() {
    ...
    __auto_type result = kr_apply_int(5, _kr_cl_alloc((void*)_kr_cl_158, 1, (int64_t)multiplier));
...
int64_t kr_main() {
    ...
    failures = _KR_ADD(failures, kr_test_explicit_types());
    failures = _KR_ADD(failures, kr_test_type_inference());
    failures = _KR_ADD(failures, kr_test_higher_order());
    failures = _KR_ADD(failures, kr_test_closure_capture());
    return failures;
}
