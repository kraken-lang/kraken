...
int64_t kr_id(void* T, void* :, void* T, void* ;, void* (, x {, int64_t id, void* (, void* if, void* {, void* }, test_type_inference }, int64_t ), void* let, void* =, void* ), void* !=, void* 1, void* 0, x apply_int, f int, int64_t fn);
