...
void kr_main() {
    kr_puts("=== Threading Tests ===");
    kr_puts("Testing sleep_ms...");
    kr_sleep_ms(10);
    kr_puts("sleep_ms: PASS");
    kr_puts("Testing mutex_create...");
    __auto_type m = kr_mutex_create();
    kr_puts("mutex_create: PASS");
    kr_puts("Testing mutex_lock...");
    kr_mutex_lock(m);
    kr_puts("mutex_lock: PASS");
    kr_puts("Testing mutex_unlock...");
    kr_mutex_unlock(m);
    kr_puts("mutex_unlock: PASS");
    kr_puts("Testing mutex_destroy...");
    kr_mutex_destroy(m);
    kr_puts("mutex_destroy: PASS");
    kr_puts("All threading tests complete!");
}
