...
int64_t kr_fetch_value();
int64_t kr_add_ten(int64_t x);
int64_t kr_chained();
int64_t kr_pipeline();
int64_t kr_main();
...
int64_t kr_chained() {
    __auto_type a = ((int64_t)(intptr_t)kr_fetch_value());
    __auto_type b = ((int64_t)(intptr_t)kr_add_ten(a));
    return b;
}

int64_t kr_pipeline() {
    __auto_type x = ((int64_t)(intptr_t)kr_fetch_value());
    __auto_type y = ((int64_t)(intptr_t)kr_add_ten(x));
    __auto_type z = ((int64_t)(intptr_t)kr_add_ten(y));
    return _KR_ADD(z, x) - 3;
}

int64_t kr_main() {
    __auto_type r1 = kr_block_on((void*)(intptr_t)(kr_chained()));
    kr_puts(kr_str_concat("chained: ", kr_fmt_int((int64_t)(intptr_t)(r1))));
    __auto_type r2 = kr_block_on((void*)(intptr_t)(kr_pipeline()));
    kr_puts(kr_str_concat("pipeline: ", kr_fmt_int((int64_t)(intptr_t)(r2))));
    return 0;
}
