...
typedef struct Align8 Align8;
typedef struct Align16 Align16;
...
int64_t kr_main() {
    Outer outer = (Outer){.x = 10, .inner = (Inner){.a = 1, .b = 2}};
    Align8 a8 = (Align8){.data = 8};
    Align16 a16 = (Align16){.data = 16};
    Align32 a32 = (Align32){.data = 32};
    Empty empty = (Empty){};
    return _KR_ADD(_KR_ADD(_KR_ADD(outer.x, a8.data), a16.data), a32.data);
}
