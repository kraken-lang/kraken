...
int64_t kr_test_padding_calculation();
int64_t kr_test_offset_alignment();
int64_t kr_test_type_alignment();
int64_t kr_main();


int64_t kr_test_padding_calculation() {
    int64_t padding1 = kr_kraken_calculate_padding(5, 4);
    int64_t padding2 = kr_kraken_calculate_padding(8, 4);
    int64_t padding3 = kr_kraken_calculate_padding(1, 8);
    return _KR_ADD(_KR_ADD(padding1, padding2), padding3);
}

int64_t kr_test_offset_alignment() {
    int64_t aligned1 = kr_kraken_align_offset(5, 4);
    int64_t aligned2 = kr_kraken_align_offset(8, 4);
    int64_t aligned3 = kr_kraken_align_offset(1, 16);
    return _KR_ADD(_KR_ADD(aligned1, aligned2), aligned3);
}

int64_t kr_test_type_alignment() {
    int64_t align1 = kr_kraken_type_alignment(1);
    int64_t align2 = kr_kraken_type_alignment(2);
    int64_t align4 = kr_kraken_type_alignment(4);
    int64_t align8 = kr_kraken_type_alignment(8);
    return _KR_ADD(_KR_ADD(_KR_ADD(align1, align2), align4), align8);
}

int64_t kr_main() {
    int64_t result1 = kr_test_padding_calculation();
    int64_t result2 = kr_test_offset_alignment();
    int64_t result3 = kr_test_type_alignment();
    return _KR_ADD(_KR_ADD(result1, result2), result3);
}
