...
int64_t kr_kraken_calculate_padding(int64_t offset, int64_t alignment);
int64_t kr_kraken_align_offset(int64_t offset, int64_t alignment);
int64_t kr_kraken_type_alignment(int64_t type_size);
...
int64_t kr_kraken_calculate_padding(int64_t offset, int64_t alignment) {
    extern;
    fn;
    kr_kraken_align_offset(offset, int, alignment, int);
    ->;
    int;
    extern;
    fn;
    kr_kraken_type_alignment(type_size, int);
    ->;
    int;
    fn;
    kr_test_padding_calculation();
    ->;
    int;
    {;
