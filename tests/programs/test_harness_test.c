...
void kr_main() {
    kr_test_section("Test Harness Demo");
    kr_test_pass("Basic assertion works");
    kr_test_pass("Math functions work");
    kr_test_skip("Feature not implemented yet");
    kr_test_section("Vector Tests");
    kr_test_pass("vec_int_push works");
    kr_test_pass("vec_int_pop works");
    kr_puts("Test harness demo complete!");
}
