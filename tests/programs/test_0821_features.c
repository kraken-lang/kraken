...
KrTuple2 kr_pair(int64_t first, int64_t second);
...
static int64_t _kr_cl_122(void*, int64_t);
static int64_t _kr_cl_164(void*, int64_t);
static int64_t _kr_cl_217(void*, int64_t);
static int64_t _kr_cl_239(void*, int64_t);
static int64_t _kr_cl_251(void*, int64_t);
static int64_t _kr_cl_251(void* _env, int64_t x) {
    return _KR_ADD(x, 1);
}

static int64_t _kr_cl_239(void* _env, int64_t x) {
    return x * 2;
}
...
static int64_t _kr_cl_217(void* _env, int64_t x) {
...
static int64_t _kr_cl_122(void* _env, int64_t x) {
    return x * 2;
}
...
int64_t kr_test_higher_order_basic() {
    __auto_type result = kr_apply_int(5, _kr_cl_alloc((void*)_kr_cl_122, 0));
...
int64_t kr_test_higher_order_capture() {
    ...
    __auto_type result = kr_apply_int(5, _kr_cl_alloc((void*)_kr_cl_164, 1, (int64_t)multiplier));
...
void* kr_compose_int(void* f, void* g) {
    return _kr_cl_alloc((void*)_kr_cl_217, 2, (int64_t)f, (int64_t)g);
}

int64_t kr_test_composition() {
    __auto_type double_val = _kr_cl_alloc((void*)_kr_cl_239, 0);
    __auto_type add_one = _kr_cl_alloc((void*)_kr_cl_251, 0);
...
int64_t kr_test_multiple_generics() {
    ...
    KrTuple2 _kr_tup_353 = p;
    __auto_type x = _kr_tup_353.f0;
    __auto_type y = _kr_tup_353.f1;
    if (_KR_NEQ(x, 42)) {
        return 1;
    }
    if (!y) {
...
int64_t kr_main() {
    ...
    failures = _KR_ADD(failures, kr_test_inference_from_context());
    failures = _KR_ADD(failures, kr_test_explicit_type_args());
    failures = _KR_ADD(failures, kr_test_higher_order_basic());
    failures = _KR_ADD(failures, kr_test_higher_order_capture());
    failures = _KR_ADD(failures, kr_test_composition());
    failures = _KR_ADD(failures, kr_test_multiple_generics());
    failures = _KR_ADD(failures, kr_test_generic_struct());
    failures = _KR_ADD(failures, kr_test_nested_generics());
