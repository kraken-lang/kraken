...
int64_t kr_id(void* T, void* :, void* T, void* ;, void* (, x {, id int, void* 42, void* (, void* ), void* ;, void* ;, void* (, x {, int64_t id, void* (, x if, void* 42, void* 1, void* 0, x apply_int, f int, int64_t fn);
int64_t kr_test_higher_order_basic();
int64_t kr_test_higher_order_capture();
void kr_compose_int(void* f, void* int, void* ,, void* (, void* int, void* (, void* int, f x, x g);
