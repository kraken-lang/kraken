...
#undef kr_printf
int64_t kr_printf(kr_str format, ...);
void kr_user_log(int64_t level, kr_str message, ...);
int64_t kr_regular_func(int64_t a, kr_str b);
int64_t kr_main();
...
int64_t kr_main() {
    int64_t result = kr_printf("Hello %s", "world");
    return 0;
}
