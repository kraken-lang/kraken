...
int64_t kr_main() {
    void* m = (void*)(intptr_t)(kr_map_string_int_new());
    kr_map_string_int_set(m, "one", 1);
    kr_map_string_int_set(m, "two", 2);
    kr_map_string_int_set(m, "three", 3);
    __auto_type len = kr_map_string_int_len(m);
    __auto_type val = kr_map_string_int_get(m, "two");
    __auto_type has_two = kr_map_string_int_has(m, "two");
    __auto_type has_four = kr_map_string_int_has(m, "four");
    kr_map_string_int_free(m);
    return _KR_ADD(_KR_ADD(_KR_ADD(len, val), has_two), has_four);
}
