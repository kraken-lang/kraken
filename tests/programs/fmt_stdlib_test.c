...
void kr_main() {
    __auto_type int_str = kr_fmt_int((int64_t)(intptr_t)(42));
    kr_puts(int_str);
    __auto_type neg_str = kr_fmt_int((int64_t)(intptr_t)(-123));
    kr_puts(neg_str);
    __auto_type hex_str = kr_fmt_hex(255);
    kr_puts(hex_str);
    __auto_type true_str = kr_fmt_bool(true);
    kr_puts(true_str);
    __auto_type false_str = kr_fmt_bool(false);
    kr_puts(false_str);
    __auto_type float_str = kr_fmt_float(3.14159, 2);
    kr_puts(float_str);
    kr_puts("All format stdlib tests passed!");
}
