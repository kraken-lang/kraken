...
int64_t kr_scan3(kr_str source, void* kinds, void* lines);
int64_t kr_main();
...
int64_t kr_main() {
    ...
    __auto_type count = kr_scan3("hello", kinds, lines);
    kr_puts(kr_str_concat("count: ", kr_fmt_int((int64_t)(intptr_t)(count))));
    __auto_type i = 0;
    while (i < count) {
        kr_puts(kr_str_concat(kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(kinds, i))), kr_str_concat(" ", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(lines, i))))));
        i = _KR_ADD(i, 1);
    }
