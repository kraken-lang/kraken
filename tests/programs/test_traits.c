...
typedef struct { kr_str (*fmt)(void*); } Display_VT;
typedef struct { kr_str (*name)(void*); kr_str (*greet)(void*); } Greet_VT;
typedef struct { int64_t (*get)(void*); } Container_VT;
static kr_str _kr_Point_Display_fmt_wrap(void* _self) { return kr_Point_fmt(*(Point*)_self); }
static Display_VT _kr_Point_Display_vt = { .fmt = _kr_Point_Display_fmt_wrap };
kr_str kr_Person_greet(Person self) {
    return "Hello";
}

static kr_str _kr_Person_Greet_name_wrap(void* _self) { return kr_Person_name(*(Person*)_self); }
static kr_str _kr_Person_Greet_greet_wrap(void* _self) { return kr_Person_greet(*(Person*)_self); }
static Greet_VT _kr_Person_Greet_vt = { .name = _kr_Person_Greet_name_wrap, .greet = _kr_Person_Greet_greet_wrap };
static int64_t _kr_Box_Container_get_wrap(void* _self) { return kr_Box_get(*(Box*)_self); }
static Container_VT _kr_Box_Container_vt = { .get = _kr_Box_Container_get_wrap };
