...
int64_t kr_main() {
    ...
    int64_t h = kr_str_char_at(s, 0);
    int64_t e = kr_str_char_at(s, 1);
    if (_KR_NEQ(h, 104)) {
        return 2;
    }
    if (_KR_NEQ(e, 101)) {
    ...
    kr_str world = (kr_str)(intptr_t)(kr_str_slice(s, 6, 11));
    int64_t world_len = kr_str_len(world);
    if (_KR_NEQ(world_len, 5)) {
        return 4;
    }
    kr_str greeting = (kr_str)(intptr_t)(kr_str_concat("Hello, ", "Kraken!"));
    int64_t greeting_len = kr_str_len(greeting);
    if (_KR_NEQ(greeting_len, 14)) {
        return 5;
    }
    return 0;
}
