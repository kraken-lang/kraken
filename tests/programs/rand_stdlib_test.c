...
void kr_main() {
    kr_rand_seed(12345);
    __auto_type r1 = kr_rand_int(1, 10);
    kr_assert(r1 >= 1);
    kr_assert(r1 <= 10);
    __auto_type r2 = kr_rand_int(0, 100);
    kr_assert(r2 >= 0);
    kr_assert(r2 <= 100);
    __auto_type r3 = kr_rand_int(-50, 50);
    kr_assert(r3 >= -50);
    kr_assert(r3 <= 50);
    __auto_type f1 = kr_rand_float();
    __auto_type f2 = kr_rand_float();
    __auto_type f3 = kr_rand_float();
    kr_rand_seed(99999);
    __auto_type a1 = kr_rand_int(0, 1000);
    __auto_type a2 = kr_rand_int(0, 1000);
    kr_rand_seed(99999);
    __auto_type b1 = kr_rand_int(0, 1000);
    __auto_type b2 = kr_rand_int(0, 1000);
    kr_assert_eq(a1, b1);
    kr_assert_eq(a2, b2);
    kr_puts("All random stdlib tests passed!");
}
