...
static int64_t _kr_cl_13(void*, int64_t);
static int64_t _kr_cl_60(void*);
static int64_t _kr_cl_89(void*, int64_t);
static int64_t _kr_cl_126(void*);
static int64_t _kr_cl_136(void*);
static int64_t _kr_cl_191(void*, int64_t);
static int64_t _kr_cl_229(void*);
static int64_t _kr_cl_285(void*, int64_t);
static int64_t _kr_cl_360(void*);
static int64_t _kr_cl_368(void*);
static int64_t _kr_cl_411(void*);
static int64_t _kr_cl_420(void*);
static int64_t _kr_cl_464(void*, int64_t);
static int64_t _kr_cl_513(void*);
static int64_t _kr_cl_553(void*, int64_t);
static int64_t _kr_cl_585(void*, int64_t, int64_t);
static kr_str _kr_cl_628(void*, kr_str);
static int64_t _kr_cl_667(void*);
static int64_t _kr_cl_691(void*);
static int64_t _kr_cl_701(void*);
static int64_t _kr_cl_711(void*);
static int64_t _kr_cl_758(void*, int64_t);
static int64_t _kr_cl_773(void*, int64_t);
static int64_t _kr_cl_788(void*, int64_t);
static int64_t _kr_cl_853(void*);
#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_853(void* _env) {
    return x;
}
#undef x
#undef kr_x
...
#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_788(void* _env, int64_t y) {
    return x - y;
}
#undef x
#undef kr_x
...
#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_773(void* _env, int64_t y) {
    return x * y;
}
#undef x
#undef kr_x
...
#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_758(void* _env, int64_t y) {
    return _KR_ADD(x, y);
}
#undef x
#undef kr_x
...
static int64_t _kr_cl_711(void* _env) {
...
#define b ((int64_t*)_env)[1]
#define kr_b ((int64_t*)_env)[1]
static int64_t _kr_cl_701(void* _env) {
    __auto_type c = 3;
    __auto_type level3 = _kr_cl_alloc((void*)_kr_cl_711, 3, (int64_t)a, (int64_t)b, (int64_t)c);
    return ((int64_t(*)(void*))_KR_CL_FN(level3))(_KR_CL_ENV(level3));
}
#undef a
#undef kr_a
#undef b
...
#define a ((int64_t*)_env)[0]
#define kr_a ((int64_t*)_env)[0]
static int64_t _kr_cl_691(void* _env) {
    __auto_type b = 2;
    __auto_type level2 = _kr_cl_alloc((void*)_kr_cl_701, 2, (int64_t)a, (int64_t)b);
    return ((int64_t(*)(void*))_KR_CL_FN(level2))(_KR_CL_ENV(level2));
}
#undef a
#undef kr_a

#define is_valid ((int64_t*)_env)[0]
#define kr_is_valid ((int64_t*)_env)[0]
static int64_t _kr_cl_667(void* _env) {
    return is_valid;
}
#undef is_valid
#undef kr_is_valid

#define message ((int64_t*)_env)[0]
#define kr_message ((int64_t*)_env)[0]
static kr_str _kr_cl_628(void* _env, kr_str name) {
    return _KR_ADD(_KR_ADD(message, ", "), name);
}
#undef message
#undef kr_message

static int64_t _kr_cl_585(void* _env, int64_t x, int64_t y) {
    return _KR_ADD(x, y);
}
...
#define flag ((int64_t*)_env)[0]
#define kr_flag ((int64_t*)_env)[0]
#define x ((int64_t*)_env)[1]
#define kr_x ((int64_t*)_env)[1]
#define y ((int64_t*)_env)[2]
#define kr_y ((int64_t*)_env)[2]
static int64_t _kr_cl_513(void* _env) {
    if (flag) {
        return x;
    }
    else {
...
#define b ((int64_t*)_env)[1]
#define kr_b ((int64_t*)_env)[1]
static int64_t _kr_cl_464(void* _env, int64_t c) {
    return _KR_ADD(_KR_ADD(a, b), c);
}
#undef a
#undef kr_a
...
static int64_t _kr_cl_420(void* _env) {
    return kr_vec_int_get(arr, 4);
}
#undef arr
#undef kr_arr
...
#define arr ((int64_t*)_env)[0]
#define kr_arr ((int64_t*)_env)[0]
static int64_t _kr_cl_411(void* _env) {
    return kr_vec_int_get(arr, 0);
}
#undef arr
#undef kr_arr

#define p (*(Point*)(((int64_t*)_env)[0]))
#define kr_p (*(Point*)(((int64_t*)_env)[0]))
static int64_t _kr_cl_368(void* _env) {
    return p.y;
}
#undef p
#undef kr_p
...
#define p (*(Point*)(((int64_t*)_env)[0]))
#define kr_p (*(Point*)(((int64_t*)_env)[0]))
static int64_t _kr_cl_360(void* _env) {
    return p.x;
}
#undef p
#undef kr_p
...
#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_285(void* _env, int64_t y) {
    return _KR_ADD(x, y);
}
#undef x
#undef kr_x
...
static int64_t _kr_cl_229(void* _env) {
...
#define sum ((int64_t*)_env)[0]
#define kr_sum ((int64_t*)_env)[0]
static int64_t _kr_cl_191(void* _env, int64_t x) {
    return _KR_ADD(sum, x);
}
#undef sum
#undef kr_sum

#define outer ((int64_t*)_env)[0]
#define kr_outer ((int64_t*)_env)[0]
#define middle ((int64_t*)_env)[1]
#define kr_middle ((int64_t*)_env)[1]
static int64_t _kr_cl_136(void* _env) {
    return _KR_ADD(outer, middle);
}
#undef outer
#undef kr_outer
#undef middle
...
#define outer ((int64_t*)_env)[0]
#define kr_outer ((int64_t*)_env)[0]
static int64_t _kr_cl_126(void* _env) {
    __auto_type middle = 20;
    __auto_type innermost = _kr_cl_alloc((void*)_kr_cl_136, 2, (int64_t)outer, (int64_t)middle);
    return ((int64_t(*)(void*))_KR_CL_FN(innermost))(_KR_CL_ENV(innermost));
}
#undef outer
#undef kr_outer
...
#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_89(void* _env, int64_t y) {
    return _KR_ADD(x, y);
}
#undef x
#undef kr_x
...
#define c ((int64_t*)_env)[2]
#define kr_c ((int64_t*)_env)[2]
static int64_t _kr_cl_60(void* _env) {
    return _KR_ADD(_KR_ADD(a, b), c);
}
#undef a
#undef kr_a
...
#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_13(void* _env, int64_t y) {
    return _KR_ADD(x, y);
}
#undef x
#undef kr_x

void* kr_make_adder(int64_t x);
void* kr_make_adder(int64_t x) {
    return _kr_cl_alloc((void*)_kr_cl_285, 1, (int64_t)x);
}

void kr_test_capture_by_reference() {
    __auto_type x = 10;
    __auto_type closure = _kr_cl_alloc((void*)_kr_cl_13, 1, (int64_t)x);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(closure))(_KR_CL_ENV(closure), 5);
}
...
void kr_test_capture_multiple_vars() {
    ...
    __auto_type b = 2;
    __auto_type c = 3;
    __auto_type closure = _kr_cl_alloc((void*)_kr_cl_60, 3, (int64_t)a, (int64_t)b, (int64_t)c);
    __auto_type result = ((int64_t(*)(void*))_KR_CL_FN(closure))(_KR_CL_ENV(closure));
}

void kr_test_capture_by_value_move() {
    __auto_type x = 42;
    __auto_type closure = _kr_cl_alloc((void*)_kr_cl_89, 1, (int64_t)x);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(closure))(_KR_CL_ENV(closure), 8);
}

void kr_test_nested_capture() {
    __auto_type outer = 10;
    __auto_type inner_closure = _kr_cl_alloc((void*)_kr_cl_126, 1, (int64_t)outer);
    __auto_type result = ((int64_t(*)(void*))_KR_CL_FN(inner_closure))(_KR_CL_ENV(inner_closure));
}
...
void kr_test_capture_in_loop() {
    ...
    {
        __auto_type _kr_arr_185 = arr;
        for (int64_t _kr_i_185 = 0; _kr_i_185 < kr_vec_int_len(_kr_arr_185); _kr_i_185++) {
            __auto_type i = kr_vec_int_get(_kr_arr_185, _kr_i_185);
            __auto_type add_to_sum = _kr_cl_alloc((void*)_kr_cl_191, 1, (int64_t)sum);
            sum = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add_to_sum))(_KR_CL_ENV(add_to_sum), i);
        }
    }
}
...
void kr_test_capture_mutable_reference() {
    ...
    __auto_type increment = _kr_cl_alloc((void*)_kr_cl_229, 1, (int64_t)counter);
    __auto_type r1 = ((int64_t(*)(void*))_KR_CL_FN(increment))(_KR_CL_ENV(increment));
    __auto_type r2 = ((int64_t(*)(void*))_KR_CL_FN(increment))(_KR_CL_ENV(increment));
    __auto_type r3 = ((int64_t(*)(void*))_KR_CL_FN(increment))(_KR_CL_ENV(increment));
}

void kr_test_capture_from_parameter() {
    __auto_type add5 = kr_make_adder(5);
    __auto_type add10 = kr_make_adder(10);
    __auto_type result1 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add5))(_KR_CL_ENV(add5), 3);
    __auto_type result2 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add10))(_KR_CL_ENV(add10), 3);
}

void kr_test_capture_struct_field() {
    __auto_type p = (Point){.x = 10, .y = 20};
    __auto_type get_x = _kr_cl_alloc((void*)_kr_cl_360, 1, _kr_box(&p, sizeof(p)));
    __auto_type get_y = _kr_cl_alloc((void*)_kr_cl_368, 1, _kr_box(&p, sizeof(p)));
    __auto_type x_val = ((int64_t(*)(void*))_KR_CL_FN(get_x))(_KR_CL_ENV(get_x));
    __auto_type y_val = ((int64_t(*)(void*))_KR_CL_FN(get_y))(_KR_CL_ENV(get_y));
}

void kr_test_capture_array_element() {
    __auto_type arr = _kr_vec_int_of(5, (int64_t)1, (int64_t)2, (int64_t)3, (int64_t)4, (int64_t)5);
    __auto_type get_first = _kr_cl_alloc((void*)_kr_cl_411, 1, (int64_t)arr);
    __auto_type get_last = _kr_cl_alloc((void*)_kr_cl_420, 1, (int64_t)arr);
    __auto_type first = ((int64_t(*)(void*))_KR_CL_FN(get_first))(_KR_CL_ENV(get_first));
    __auto_type last = ((int64_t(*)(void*))_KR_CL_FN(get_last))(_KR_CL_ENV(get_last));
}
...
void kr_test_mixed_captures() {
    ...
    __auto_type b = 2;
    __auto_type c = 3;
    __auto_type closure = _kr_cl_alloc((void*)_kr_cl_464, 2, (int64_t)a, (int64_t)b);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(closure))(_KR_CL_ENV(closure), 10);
}
...
void kr_test_capture_in_conditional() {
    ...
    __auto_type x = 10;
    __auto_type y = 20;
    __auto_type closure = _kr_cl_alloc((void*)_kr_cl_513, 3, (int64_t)flag, (int64_t)x, (int64_t)y);
    __auto_type result = ((int64_t(*)(void*))_KR_CL_FN(closure))(_KR_CL_ENV(closure));
}

void kr_test_capture_shadowing() {
    __auto_type x = 10;
    __auto_type closure = _kr_cl_alloc((void*)_kr_cl_553, 0);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(closure))(_KR_CL_ENV(closure), 5);
}

void kr_test_no_capture() {
    __auto_type closure = _kr_cl_alloc((void*)_kr_cl_585, 0);
    __auto_type result = ((int64_t(*)(void*, int64_t, int64_t))_KR_CL_FN(closure))(_KR_CL_ENV(closure), 3, 4);
}

void kr_test_capture_string() {
    __auto_type message = "Hello";
    __auto_type greet = _kr_cl_alloc((void*)_kr_cl_628, 1, (int64_t)message);
    __auto_type greeting = ((int64_t(*)(void*, int64_t))_KR_CL_FN(greet))(_KR_CL_ENV(greet), "World");
}

void kr_test_capture_bool() {
    __auto_type is_valid = true;
    __auto_type check = _kr_cl_alloc((void*)_kr_cl_667, 1, (int64_t)is_valid);
    __auto_type result = ((int64_t(*)(void*))_KR_CL_FN(check))(_KR_CL_ENV(check));
}

void kr_test_deep_nesting() {
    __auto_type a = 1;
    __auto_type level1 = _kr_cl_alloc((void*)_kr_cl_691, 1, (int64_t)a);
    __auto_type result = ((int64_t(*)(void*))_KR_CL_FN(level1))(_KR_CL_ENV(level1));
}

void kr_test_closure_array() {
    __auto_type x = 10;
    __auto_type closures = _kr_vec_int_of(3, (int64_t)_kr_cl_alloc((void*)_kr_cl_758, 1, (int64_t)x), (int64_t)_kr_cl_alloc((void*)_kr_cl_773, 1, (int64_t)x), (int64_t)_kr_cl_alloc((void*)_kr_cl_788, 1, (int64_t)x));
    __auto_type r1 = _kr_cl_call1((void*)kr_vec_int_get(closures, 0), 5);
    __auto_type r2 = _kr_cl_call1((void*)kr_vec_int_get(closures, 1), 5);
    __auto_type r3 = _kr_cl_call1((void*)kr_vec_int_get(closures, 2), 5);
}

void kr_test_move_prevents_later_use() {
    __auto_type x = 42;
    __auto_type closure = _kr_cl_alloc((void*)_kr_cl_853, 1, (int64_t)x);
    __auto_type result = ((int64_t(*)(void*))_KR_CL_FN(closure))(_KR_CL_ENV(closure));
}
