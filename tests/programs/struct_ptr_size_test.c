...
P2 kr_ret2(P2 s) {
    return (P2){.a = _KR_ADD(s.a, 1), .b = s.b};
}

P3 kr_ret3(P3 s) {
    return (P3){.a = _KR_ADD(s.a, 1), .b = s.b, .c = s.c};
}

P4 kr_ret4(P4 s) {
    return (P4){.a = _KR_ADD(s.a, 1), .b = s.b, .c = s.c, .d = s.d};
}

P5 kr_ret5(P5 s) {
    return (P5){.a = _KR_ADD(s.a, 1), .b = s.b, .c = s.c, .d = s.d, .e = s.e};
}

int64_t kr_main() {
    void* v1 = (void*)(intptr_t)(kr_vec_int_new());
    void* v2 = (void*)(intptr_t)(kr_vec_int_new());
    void* v3 = (void*)(intptr_t)(kr_vec_int_new());
    void* v4 = (void*)(intptr_t)(kr_vec_int_new());
    void* v5 = (void*)(intptr_t)(kr_vec_int_new());
    P1 s1 = (P1){.a = v1};
    s1 = kr_ret1(s1);
    kr_vec_int_push(s1.a, 1);
    kr_puts(kr_str_concat("P1 (8B) ok val=", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(s1.a, 0)))));
    P2 s2 = (P2){.a = 0, .b = v2};
    s2 = kr_ret2(s2);
    kr_puts(kr_str_concat("P2 a=", kr_fmt_int((int64_t)(intptr_t)(s2.a))));
    kr_vec_int_push(s2.b, 2);
    kr_puts(kr_str_concat("P2 (16B) ok val=", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(s2.b, 0)))));
    P3 s3 = (P3){.a = 0, .b = 10, .c = v3};
    s3 = kr_ret3(s3);
    kr_puts(kr_str_concat("P3 a=", kr_fmt_int((int64_t)(intptr_t)(s3.a))));
    kr_vec_int_push(s3.c, 3);
    kr_puts(kr_str_concat("P3 (24B) ok val=", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(s3.c, 0)))));
    P4 s4 = (P4){.a = 0, .b = 10, .c = 20, .d = v4};
    s4 = kr_ret4(s4);
    kr_puts(kr_str_concat("P4 a=", kr_fmt_int((int64_t)(intptr_t)(s4.a))));
    kr_vec_int_push(s4.d, 4);
    kr_puts(kr_str_concat("P4 (32B) ok val=", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(s4.d, 0)))));
    P5 s5 = (P5){.a = 0, .b = 10, .c = 20, .d = 30, .e = v5};
    s5 = kr_ret5(s5);
    kr_puts(kr_str_concat("P5 a=", kr_fmt_int((int64_t)(intptr_t)(s5.a))));
    kr_vec_int_push(s5.e, 5);
    kr_puts(kr_str_concat("P5 (40B) ok val=", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(s5.e, 0)))));
    kr_vec_int_free(v1);
    kr_vec_int_free(v2);
    kr_vec_int_free(v3);
    kr_vec_int_free(v4);
