...
static int64_t _kr_cl_24(void*, int64_t);
static int64_t _kr_cl_79(void*, int64_t);
static int64_t _kr_cl_129(void*, int64_t);
#define factor ((int64_t*)_env)[0]
#define kr_factor ((int64_t*)_env)[0]
static int64_t _kr_cl_129(void* _env, int64_t x) {
    return x * factor;
}
#undef factor
#undef kr_factor

#define base ((int64_t*)_env)[0]
#define kr_base ((int64_t*)_env)[0]
#define scale ((int64_t*)_env)[1]
#define kr_scale ((int64_t*)_env)[1]
static int64_t _kr_cl_79(void* _env, int64_t x) {
    return _KR_ADD(base, x * scale);
}
#undef base
#undef kr_base
#undef scale
...
static int64_t _kr_cl_24(void* _env, int64_t x) {
...
int64_t kr_main() {
    int64_t offset = 10;
    void* add_offset = (void*)(intptr_t)(_kr_cl_alloc((void*)_kr_cl_24, 1, (int64_t)offset));
    kr_puts(kr_str_concat("add_offset(5): ", kr_fmt_int((int64_t)(intptr_t)(((int64_t(*)(void*, int64_t))_KR_CL_FN(add_offset))(_KR_CL_ENV(add_offset), 5)))));
    int64_t base = 100;
    int64_t scale = 3;
    void* compute = (void*)(intptr_t)(_kr_cl_alloc((void*)_kr_cl_79, 2, (int64_t)base, (int64_t)scale));
    kr_puts(kr_str_concat("compute(7): ", kr_fmt_int((int64_t)(intptr_t)(((int64_t(*)(void*, int64_t))_KR_CL_FN(compute))(_KR_CL_ENV(compute), 7)))));
    int64_t factor = 4;
    void* multiply = (void*)(intptr_t)(_kr_cl_alloc((void*)_kr_cl_129, 1, (int64_t)factor));
    kr_puts(kr_str_concat("multiply(8): ", kr_fmt_int((int64_t)(intptr_t)(((int64_t(*)(void*, int64_t))_KR_CL_FN(multiply))(_KR_CL_ENV(multiply), 8)))));
    return 0;
}
