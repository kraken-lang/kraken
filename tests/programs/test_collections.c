...
int64_t kr_main() {
    ...
    kr_puts("");
    failures = failures + kr_test_range_iterator();
    failures = failures + kr_test_clone();
    failures = failures + kr_test_array_any();
    failures = failures + kr_test_array_all();
    failures = failures + kr_test_array_find();
    kr_puts("");
