...
int64_t kr_kraken_range_iter(int64_t start, int64_t end, int64_t step);
int64_t kr_kraken_range_next(int64_t iter, int64_t value_ptr);
void kr_kraken_range_free(int64_t iter);
int64_t kr_kraken_clone(int64_t value, int64_t size);
int64_t kr_kraken_array_any(int64_t arr, int64_t len, int64_t elem_size, int64_t predicate);
int64_t kr_kraken_array_all(int64_t arr, int64_t len, int64_t elem_size, int64_t predicate);
int64_t kr_kraken_array_find(int64_t arr, int64_t len, int64_t elem_size, int64_t predicate);
...
int64_t kr_kraken_range_iter(int64_t start, int64_t end, int64_t step) {
    extern;
    fn;
    kr_kraken_range_next(iter, int, value_ptr, int);
    ->;
    int;
    extern;
    fn;
    kr_kraken_range_free(iter, int);
    ->;
    void;
    extern;
    fn;
    kr_kraken_clone(value, int, size, int);
    ->;
    int;
    extern;
    fn;
    kr_kraken_array_any(arr, int, len, int, elem_size, int, predicate, int);
    ->;
    int;
    extern;
    fn;
    kr_kraken_array_all(arr, int, len, int, elem_size, int, predicate, int);
    ->;
    int;
    extern;
    fn;
    kr_kraken_array_find(arr, int, len, int, elem_size, int, predicate, int);
    ->;
    int;
    fn;
    kr_test_range_iterator();
    ->;
    int;
    {;
