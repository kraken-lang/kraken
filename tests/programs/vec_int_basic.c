...
int64_t kr_main() {
    ...
    kr_puts(kr_str_concat("len=", kr_fmt_int(kr_vec_int_len(v))));
    kr_puts(kr_str_concat("v[0]=", kr_fmt_int(kr_vec_int_get(v, 0))));
    kr_puts(kr_str_concat("v[1]=", kr_fmt_int(kr_vec_int_get(v, 1))));
    kr_vec_int_free(v);
    return 0;
}
