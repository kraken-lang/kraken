...
int64_t kr_test_tuple_edge_cases() {
    ...
    KrTuple1 unit = (KrTuple1){.f0=0};
    kr_test_pass("Empty tuple (unit type)");
    KrTuple2 pair = (KrTuple2){.f0 = 42, .f1 = 43};
    kr_assert_eq(pair.f0, 42);
    kr_assert_eq(pair.f1, 43);
    kr_test_pass("Two element tuple");
    KrTuple10 large = (KrTuple10){.f0 = 1, .f1 = 2, .f2 = 3, .f3 = 4, .f4 = 5, .f5 = 6, .f6 = 7, .f7 = 8, .f8 = 9, .f9 = 10};
    kr_assert_eq(large.f0, 1);
    kr_assert_eq(large.f5, 6);
    kr_assert_eq(large.f9, 10);
    kr_test_pass("Large tuple (10 elements)");
    KrTuple2 nested = (KrTuple2){.f0 = ({KrTuple2 _t = (KrTuple2){.f0 = 1, .f1 = 2}; _kr_box(&_t, sizeof(KrTuple2));}), .f1 = ({KrTuple2 _t = (KrTuple2){.f0 = 3, .f1 = 4}; _kr_box(&_t, sizeof(KrTuple2));})};
    KrTuple2 first = *(KrTuple2*)(intptr_t)(nested.f0);
    KrTuple2 second = *(KrTuple2*)(intptr_t)(nested.f1);
    kr_assert_eq(first.f0, 1);
    kr_assert_eq(first.f1, 2);
    kr_assert_eq(second.f0, 3);
    kr_assert_eq(second.f1, 4);
    kr_test_pass("Deeply nested tuples");
    KrTuple2 triple = (KrTuple2){.f0 = ({KrTuple2 _t = (KrTuple2){.f0 = ({KrTuple2 _t = (KrTuple2){.f0 = 1, .f1 = 2}; _kr_box(&_t, sizeof(KrTuple2));}), .f1 = 3}; _kr_box(&_t, sizeof(KrTuple2));}), .f1 = 4};
    KrTuple2 outer = *(KrTuple2*)(intptr_t)(triple.f0);
    KrTuple2 inner = *(KrTuple2*)(intptr_t)(outer.f0);
    kr_assert_eq(inner.f0, 1);
    kr_assert_eq(inner.f1, 2);
    kr_assert_eq(outer.f1, 3);
    kr_assert_eq(triple.f1, 4);
    kr_test_pass("Triple nested tuples");
    KrTuple3 same = (KrTuple3){.f0 = 5, .f1 = 5, .f2 = 5};
    kr_assert_eq(same.f0, 5);
    kr_assert_eq(same.f1, 5);
    kr_assert_eq(same.f2, 5);
    kr_test_pass("Tuple with identical values");
    KrTuple3 with_zero = (KrTuple3){.f0 = 0, .f1 = 1, .f2 = 0};
    kr_assert_eq(with_zero.f0, 0);
    kr_assert_eq(with_zero.f1, 1);
    kr_assert_eq(with_zero.f2, 0);
    kr_test_pass("Tuple with zero values");
    KrTuple2 negative = (KrTuple2){.f0 = -1, .f1 = -100};
    kr_assert_eq(negative.f0, -1);
    kr_assert_eq(negative.f1, -100);
...
int64_t kr_test_pattern_matching_edge_cases() {
    ...
    KrTuple3 triple = (KrTuple3){.f0 = 1, .f1 = 2, .f2 = 3};
    if (1) {
        kr_test_pass("Match with all wildcards");
    }
    KrTuple3 mixed = (KrTuple3){.f0 = 5, .f1 = 10, .f2 = 15};
    if (1) {
        int64_t a = mixed.f0;
        int64_t c = mixed.f2;
        kr_assert_eq(a, 5);
    ...
    KrTuple2 nested = (KrTuple2){.f0 = ({KrTuple2 _t = (KrTuple2){.f0 = 7, .f1 = 8}; _kr_box(&_t, sizeof(KrTuple2));}), .f1 = 9};
    if (1) {
        int64_t x = (*(KrTuple2*)(intptr_t)nested.f0).f0;
        int64_t y = (*(KrTuple2*)(intptr_t)nested.f0).f1;
        int64_t z = nested.f1;
        kr_assert_eq(x, 7);
        kr_assert_eq(y, 8);
        kr_assert_eq(z, 9);
    ...
    KrTuple2 zeros = (KrTuple2){.f0 = 0, .f1 = 0};
    if (1) {
        int64_t a = zeros.f0;
        int64_t b = zeros.f1;
        kr_assert_eq(a, 0);
    ...
    KrTuple2 negs = (KrTuple2){.f0 = -5, .f1 = -10};
    if (1) {
        int64_t x = negs.f0;
        int64_t y = negs.f1;
        kr_assert_eq(x, -5);
    ...
    KrTuple5 large = (KrTuple5){.f0 = 1, .f1 = 2, .f2 = 3, .f3 = 4, .f4 = 5};
    if (1) {
        int64_t a = large.f0;
        int64_t b = large.f1;
        int64_t c = large.f2;
    ...
    KrTuple2 t1 = (KrTuple2){.f0 = 10, .f1 = 20};
    KrTuple2 _kr_tup_1326 = t1;
    __auto_type a = _kr_tup_1326.f0;
    __auto_type b = _kr_tup_1326.f1;
    KrTuple2 t2 = (KrTuple2){.f0 = a, .f1 = b};
    KrTuple2 _kr_tup_1356 = t2;
    __auto_type c = _kr_tup_1356.f0;
    __auto_type d = _kr_tup_1356.f1;
    kr_assert_eq(c, 10);
    kr_assert_eq(d, 20);
    kr_test_pass("Multiple sequential destructurings");
    KrTuple2 big_tuple = (KrTuple2){.f0 = ({KrTuple2 _t = (KrTuple2){.f0 = 1, .f1 = 2}; _kr_box(&_t, sizeof(KrTuple2));}), .f1 = ({KrTuple2 _t = (KrTuple2){.f0 = 3, .f1 = 4}; _kr_box(&_t, sizeof(KrTuple2));})};
    KrTuple2 _kr_tup_1429 = big_tuple;
    KrTuple2 first = *(KrTuple2*)(intptr_t)_kr_tup_1429.f0;
    KrTuple2 second = *(KrTuple2*)(intptr_t)_kr_tup_1429.f1;
    if (1) {
        int64_t x = first.f0;
        int64_t y = first.f1;
        kr_assert_eq(x, 1);
