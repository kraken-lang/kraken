...
void kr_main() {
    kr_puts("=== Thread Pool Tests ===");
    __auto_type pool = kr_pool_new(4);
    kr_puts("pool_new(4): PASS");
    kr_pool_shutdown(pool);
    kr_puts("pool_shutdown: PASS");
    __auto_type pool2 = kr_pool_new(2);
    kr_puts("pool_new(2): PASS");
    kr_pool_shutdown(pool2);
    kr_puts("pool_shutdown: PASS");
    kr_puts("All thread pool tests complete!");
}
