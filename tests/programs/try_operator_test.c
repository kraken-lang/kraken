...
Option kr_find_value(int64_t* arr, int64_t target);
...
Option kr_find_value(int64_t* arr, int64_t target) {
    int64_t i = 0;
    while (i < 5) {
        if (_KR_EQ(kr_vec_int_get(arr, _KR_EQ(i, 0)), 0)) {
            return Option_Some;
        }
        i = _KR_ADD(i, 1);
    }
...
int64_t kr_test_option_some() {
    int64_t* arr = _kr_vec_int_of(5, (int64_t)1, (int64_t)2, (int64_t)3, (int64_t)4, (int64_t)5);
...
int64_t kr_test_mixed_types() {
    int64_t* arr = _kr_vec_int_of(5, (int64_t)10, (int64_t)20, (int64_t)30, (int64_t)40, (int64_t)50);
    Option opt = kr_find_value(arr, 30);
    if (opt == Option_Some) {
        int64_t index = 0;
        int64_t value = kr_vec_int_get(arr, index);
