...
typedef struct { kr_str (*describe)(void*); } Describable_VT;
static kr_str _kr_Dog_Describable_describe_wrap(void* _self) { return kr_Dog_describe(*(Dog*)_self); }
static Describable_VT _kr_Dog_Describable_vt = { .describe = _kr_Dog_Describable_describe_wrap };
static kr_str _kr_Cat_Describable_describe_wrap(void* _self) { return kr_Cat_describe(*(Cat*)_self); }
static Describable_VT _kr_Cat_Describable_vt = { .describe = _kr_Cat_Describable_describe_wrap };
...
int64_t kr_main() {
    ...
    kr_puts(kr_str_concat("lives: ", kr_fmt_int((int64_t)(intptr_t)(kr_Cat_remaining_lives(c)))));
    return 0;
}
