...
int64_t kr_main() {
    __auto_type s1 = "hello world hello";
    __auto_type replaced1 = kr_str_replace(s1, "hello", "hi");
    if (!kr_str_eq(replaced1, "hi world hi")) {
        return 1;
    }
    __auto_type s2 = "test";
    __auto_type replaced2 = kr_str_replace(s2, "x", "y");
    if (!kr_str_eq(replaced2, "test")) {
        return 2;
    }
    __auto_type s3 = "aaa";
    __auto_type replaced3 = kr_str_replace(s3, "a", "bb");
    if (!kr_str_eq(replaced3, "bbbbbb")) {
        return 3;
    }
    __auto_type s4 = "hello";
    __auto_type replaced4 = kr_str_replace(s4, "", "x");
    if (!kr_str_eq(replaced4, "hello")) {
        return 4;
    }
    __auto_type s5 = "one::two::three";
    __auto_type replaced5 = kr_str_replace(s5, "::", "-");
    if (!kr_str_eq(replaced5, "one-two-three")) {
        return 5;
    }
    return 0;
}
