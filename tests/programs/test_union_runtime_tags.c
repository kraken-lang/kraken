...
int64_t kr_kraken_union_create(int64_t size, int64_t initial_tag);
void kr_kraken_union_set_tag(int64_t u, int64_t tag);
int64_t kr_kraken_union_check_tag(int64_t u, int64_t expected_tag, kr_str field_name);
int64_t kr_kraken_union_get_tag(int64_t u);
void kr_kraken_union_free(int64_t u);
...
int64_t kr_kraken_union_create(int64_t size, int64_t initial_tag) {
    extern;
    fn;
    kr_kraken_union_set_tag(u, int, tag, int);
    ->;
    void;
    extern;
    fn;
    kr_kraken_union_check_tag(u, int, expected_tag, int, field_name, str);
    ->;
    int;
    extern;
    fn;
    kr_kraken_union_get_tag(u, int);
    ->;
    int;
    extern;
    fn;
    kr_kraken_union_free(u, int);
    ->;
    void;
    fn;
    kr_test_union_tag_operations();
    ->;
    int;
    {;
