...
int64_t kr_test_union_tag_operations();
int64_t kr_main();


int64_t kr_test_union_tag_operations() {
    int64_t u = kr_kraken_union_create(16, 0);
    int64_t tag = kr_kraken_union_get_tag(u);
    kr_kraken_union_set_tag(u, 1);
    int64_t check = kr_kraken_union_check_tag(u, 1, "field1");
    kr_kraken_union_free(u);
    return 0;
}

int64_t kr_main() {
    int64_t result = kr_test_union_tag_operations();
    return result;
}
