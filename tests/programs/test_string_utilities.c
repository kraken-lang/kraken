...
int64_t kr_main() {
    ...
    failures = _KR_ADD(failures, kr_test_str_len());
    failures = _KR_ADD(failures, kr_test_str_concat());
    failures = _KR_ADD(failures, kr_test_str_substring());
    failures = _KR_ADD(failures, kr_test_str_contains());
    failures = _KR_ADD(failures, kr_test_str_starts_with());
    failures = _KR_ADD(failures, kr_test_str_ends_with());
    failures = _KR_ADD(failures, kr_test_str_to_upper());
    failures = _KR_ADD(failures, kr_test_str_to_lower());
    failures = _KR_ADD(failures, kr_test_str_trim());
    failures = _KR_ADD(failures, kr_test_str_replace());
