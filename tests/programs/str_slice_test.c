...
int64_t kr_main() {
    __auto_type s = "fn main() -> int";
    __auto_type result = kr_str_slice(s, 0, 2);
    kr_puts(kr_str_concat("slice: [", kr_str_concat(result, "]")));
    kr_puts(kr_str_concat("len: ", kr_fmt_int((int64_t)(intptr_t)(kr_strlen(result)))));
    __auto_type c = kr_str_char_at(s, 0);
    kr_puts(kr_str_concat("char_at(0): ", kr_fmt_int((int64_t)(intptr_t)(c))));
    return 0;
}
