...
void kr_kraken_bounds_check(int64_t index, int64_t length, kr_str file, int64_t line);
void kr_kraken_bounds_check_range(int64_t start, int64_t end, int64_t length, kr_str file, int64_t line);
...
void kr_kraken_bounds_check(int64_t index, int64_t length, kr_str file, int64_t line) {
    extern;
    fn;
    kr_kraken_bounds_check_range(start, int, end, int, length, int, file, str, line, int);
    ->;
    void;
    fn;
    kr_test_valid_array_access();
    ->;
    int;
    {;
