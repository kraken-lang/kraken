...
int64_t kr_test_valid_array_access();
int64_t kr_test_valid_range_access();
int64_t kr_test_boundary_access();
int64_t kr_test_empty_range();
int64_t kr_test_full_range();
int64_t kr_main();


int64_t kr_test_valid_array_access() {
    __auto_type arr_len = 10;
    __auto_type index = 5;
    kr_kraken_bounds_check(index, arr_len, "test_bounds_checking.kr", 13);
    kr_puts("Valid array access test passed");
    return 0;
}
...
int64_t kr_test_valid_range_access() {
    ...
    __auto_type start = 2;
    __auto_type end = 7;
    kr_kraken_bounds_check_range(start, end, arr_len, "test_bounds_checking.kr", 26);
    kr_puts("Valid range access test passed");
    return 0;
}

int64_t kr_test_boundary_access() {
    __auto_type arr_len = 10;
    kr_kraken_bounds_check(0, arr_len, "test_bounds_checking.kr", 37);
    kr_kraken_bounds_check(9, arr_len, "test_bounds_checking.kr", 40);
    kr_puts("Boundary access test passed");
    return 0;
}
...
int64_t kr_test_empty_range() {
    ...
    __auto_type start = 5;
    __auto_type end = 5;
    kr_kraken_bounds_check_range(start, end, arr_len, "test_bounds_checking.kr", 53);
    kr_puts("Empty range test passed");
    return 0;
}
...
int64_t kr_test_full_range() {
    ...
    __auto_type start = 0;
    __auto_type end = 10;
    kr_kraken_bounds_check_range(start, end, arr_len, "test_bounds_checking.kr", 66);
    kr_puts("Full range test passed");
    return 0;
}

int64_t kr_main() {
    __auto_type failures = 0;
    kr_puts("Testing bounds checking infrastructure...");
    kr_puts("Note: Set KRAKEN_BOUNDS_CHECK=1 to enable runtime checks");
    kr_puts("");
    failures = _KR_ADD(failures, kr_test_valid_array_access());
    failures = _KR_ADD(failures, kr_test_valid_range_access());
    failures = _KR_ADD(failures, kr_test_boundary_access());
    failures = _KR_ADD(failures, kr_test_empty_range());
    failures = _KR_ADD(failures, kr_test_full_range());
    kr_puts("");
    if (_KR_EQ(failures, 0)) {
        kr_puts("All bounds checking tests passed!");
    }
    return failures;
}
