...
int64_t kr_main() {
    ...
    kr_puts("");
    failures = failures + kr_test_valid_array_access();
    failures = failures + kr_test_valid_range_access();
    failures = failures + kr_test_boundary_access();
    failures = failures + kr_test_empty_range();
    failures = failures + kr_test_full_range();
    kr_puts("");
