...
int64_t kr_test_null_check();
int64_t kr_test_malloc_safety();
int64_t kr_main();


int64_t kr_test_null_check() {
    int64_t ptr = 12345;
    int64_t checked = kr_kraken_ffi_check_null(ptr, "test_function");
    return checked;
}

int64_t kr_test_malloc_safety() {
    int64_t ptr = kr_kraken_ffi_safe_malloc(100);
    return ptr;
}

int64_t kr_main() {
    int64_t result1 = kr_test_null_check();
    int64_t result2 = kr_test_malloc_safety();
    return 0;
}
