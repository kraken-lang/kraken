...
int64_t kr_kraken_ffi_check_null(int64_t ptr, kr_str func_name);
int64_t kr_kraken_ffi_validate_ptr(int64_t ptr, kr_str operation);
kr_str kr_kraken_ffi_validate_string(kr_str str, kr_str func_name);
int64_t kr_kraken_ffi_safe_malloc(int64_t size);
...
int64_t kr_kraken_ffi_check_null(int64_t ptr, kr_str func_name) {
    extern;
    fn;
    kr_kraken_ffi_validate_ptr(ptr, int, operation, str);
    ->;
    int;
    extern;
    fn;
    kr_kraken_ffi_validate_string(str, str, func_name, str);
    ->;
    str;
    extern;
    fn;
    kr_kraken_ffi_safe_malloc(size, int);
    ->;
    int;
    fn;
    kr_test_null_check();
