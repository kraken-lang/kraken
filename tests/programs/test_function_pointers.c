...
int64_t kr_callback_add(int64_t a, int64_t b);
int64_t kr_callback_multiply(int64_t a, int64_t b);
int64_t kr_apply_operation(int64_t a, int64_t b, void* op);
int64_t kr_callback_hello();
int64_t kr_call_simple_callback(void* cb);
int64_t kr_main();
...
int64_t kr_apply_operation(int64_t a, int64_t b, void* op) {
    return ((int64_t(*)(void*, int64_t, int64_t))_KR_CL_FN(op))(_KR_CL_ENV(op), a, b);
}
...
int64_t kr_call_simple_callback(void* cb) {
    return ((int64_t(*)(void*))_KR_CL_FN(cb))(_KR_CL_ENV(cb));
}

int64_t kr_main() {
    int64_t result1 = kr_apply_operation(10, 20, _kr_cl_alloc((void*)kr_callback_add, 0));
    int64_t result2 = kr_apply_operation(10, 20, _kr_cl_alloc((void*)kr_callback_multiply, 0));
    int64_t result3 = kr_call_simple_callback(_kr_cl_alloc((void*)kr_callback_hello, 0));
