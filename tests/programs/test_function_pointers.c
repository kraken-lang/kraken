...
int64_t kr_main() {
    int64_t result1 = kr_apply_operation(10, 20, kr_callback_add);
    int64_t result2 = kr_apply_operation(10, 20, kr_callback_multiply);
    int64_t result3 = kr_call_simple_callback(kr_callback_hello);
