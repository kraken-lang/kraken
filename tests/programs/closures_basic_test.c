...
static int64_t _kr_cl_10(void*, int64_t);
static int64_t _kr_cl_31(void*, int64_t, int64_t);
static int64_t _kr_cl_58(void*, int64_t);
static int64_t _kr_cl_93(void*, int64_t, int64_t, int64_t);
static int64_t _kr_cl_124(void*, int64_t);
static int64_t _kr_cl_151(void*, int64_t);
static int64_t _kr_cl_177(void*, int64_t);
static int64_t _kr_cl_198(void*, int64_t);
static int64_t _kr_cl_207(void*, int64_t);
static int64_t _kr_cl_231(void*);
static int64_t _kr_cl_246(void*);
static int64_t _kr_cl_246(void* _env) {
    kr_puts("Hello from closure");
}

static int64_t _kr_cl_231(void* _env) {
    return 42;
}

#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_207(void* _env, int64_t y) {
    return _KR_ADD(x, y);
}
#undef x
#undef kr_x

static int64_t _kr_cl_198(void* _env, int64_t x) {
    __auto_type inner = _kr_cl_alloc((void*)_kr_cl_207, 1, (int64_t)x);
    return x;
}

#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_177(void* _env, int64_t y) {
    return _KR_ADD(x, y);
}
#undef x
#undef kr_x
...
#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_151(void* _env, int64_t y) {
    return _KR_ADD(x, y);
}
#undef x
#undef kr_x
...
static int64_t _kr_cl_93(void* _env, int64_t a, int64_t b, int64_t c) {
    return _KR_ADD(_KR_ADD(a, b), c);
}

static int64_t _kr_cl_58(void* _env, int64_t x) {
    __auto_type doubled = x * 2;
    __auto_type result = _KR_ADD(doubled, 10);
    return result;
}

static int64_t _kr_cl_31(void* _env, int64_t x, int64_t y) {
    return x * y;
}

static int64_t _kr_cl_10(void* _env, int64_t x) {
    return _KR_ADD(x, 1);
}

int64_t kr_test_simple_closure() {
    __auto_type add_one = _kr_cl_alloc((void*)_kr_cl_10, 0);
    return 0;
}

int64_t kr_test_closure_with_return_type() {
    __auto_type multiply = _kr_cl_alloc((void*)_kr_cl_31, 0);
    return 0;
}

int64_t kr_test_closure_with_block() {
    __auto_type complex_calc = _kr_cl_alloc((void*)_kr_cl_58, 0);
    return 0;
}

int64_t kr_test_multi_param_closure() {
    __auto_type add_three = _kr_cl_alloc((void*)_kr_cl_93, 0);
    return 0;
}

int64_t kr_test_type_inference() {
    __auto_type square = _kr_cl_alloc((void*)_kr_cl_124, 0);
    return 0;
}

int64_t kr_test_move_closure() {
    __auto_type x = 10;
    __auto_type capture_x = _kr_cl_alloc((void*)_kr_cl_151, 1, (int64_t)x);
    return 0;
}

int64_t kr_test_capture_by_reference() {
    __auto_type x = 20;
    __auto_type use_x = _kr_cl_alloc((void*)_kr_cl_177, 1, (int64_t)x);
    return 0;
}

int64_t kr_test_nested_closures() {
    __auto_type outer = _kr_cl_alloc((void*)_kr_cl_198, 0);
    return 0;
}

int64_t kr_test_no_params() {
    __auto_type get_value = _kr_cl_alloc((void*)_kr_cl_231, 0);
    return 0;
}

int64_t kr_test_void_return() {
    __auto_type print_msg = _kr_cl_alloc((void*)_kr_cl_246, 0);
    return 0;
}

int64_t kr_main() {
    kr_puts("Testing basic closure syntax...");
    kr_test_simple_closure();
    kr_test_closure_with_return_type();
    kr_test_closure_with_block();
    kr_test_multi_param_closure();
    kr_test_type_inference();
    kr_test_move_closure();
    kr_test_capture_by_reference();
    kr_test_nested_closures();
    kr_test_no_params();
    kr_test_void_return();
    kr_puts("All closure syntax tests passed!");
    return 0;
}
