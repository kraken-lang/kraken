...
int64_t kr_main() {
    void* m1 = (void*)(intptr_t)(kr_map_string_int_new());
    kr_map_string_int_set(m1, "a", 1);
    kr_map_string_int_set(m1, "b", 2);
    void* keys1 = (void*)(intptr_t)(kr_map_string_int_keys(m1));
    int64_t keys_len = kr_vec_string_len(keys1);
    void* vals1 = (void*)(intptr_t)(kr_map_string_int_values(m1));
    int64_t vals_len = kr_vec_int_len(vals1);
    void* m2 = (void*)(intptr_t)(kr_map_string_string_new());
    kr_map_string_string_set(m2, "x", "hello");
    kr_map_string_string_set(m2, "y", "world");
    void* keys2 = (void*)(intptr_t)(kr_map_string_string_keys(m2));
    int64_t keys2_len = kr_vec_string_len(keys2);
    void* vals2 = (void*)(intptr_t)(kr_map_string_string_values(m2));
    int64_t vals2_len = kr_vec_string_len(vals2);
    kr_vec_string_free(keys1);
    kr_vec_int_free(vals1);
    kr_vec_string_free(keys2);
    kr_vec_string_free(vals2);
    kr_map_string_int_free(m1);
    kr_map_string_string_free(m2);
    return _KR_ADD(_KR_ADD(_KR_ADD((keys_len - 2), (vals_len - 2)), (keys2_len - 2)), (vals2_len - 2));
}
