...
int64_t kr_main() {
    __auto_type s1 = "hello,world,test";
    __auto_type parts = kr_str_split(s1, ",");
    __auto_type len = kr_vec_string_len(parts);
    if (_KR_NEQ(len, 3)) {
        return 1;
    }
    __auto_type part0 = kr_vec_string_get(parts, 0);
    __auto_type part1 = kr_vec_string_get(parts, 1);
    __auto_type part2 = kr_vec_string_get(parts, 2);
    if (!kr_str_eq(part0, "hello")) {
        return 2;
    }
    if (!kr_str_eq(part1, "world")) {
        return 3;
    }
    if (!kr_str_eq(part2, "test")) {
        return 4;
    }
    __auto_type s2 = "single";
    __auto_type parts2 = kr_str_split(s2, ",");
    __auto_type len2 = kr_vec_string_len(parts2);
    if (_KR_NEQ(len2, 1)) {
        return 5;
    }
    __auto_type s3 = "a::b::c";
    __auto_type parts3 = kr_str_split(s3, "::");
    __auto_type len3 = kr_vec_string_len(parts3);
    if (_KR_NEQ(len3, 3)) {
        return 6;
    }
    __auto_type s4 = "";
    __auto_type parts4 = kr_str_split(s4, ",");
    __auto_type len4 = kr_vec_string_len(parts4);
    if (_KR_NEQ(len4, 1)) {
        return 7;
    }
    return 0;
