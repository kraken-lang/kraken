...
int64_t kr_main() {
    ...
    KrTuple2 single = (KrTuple2){.f0 = 42};
    kr_assert_eq(single.f0, 42);
    kr_test_pass("Single element tuple");
    KrTuple8 large = (KrTuple8){.f0 = 1, .f1 = 2, .f2 = 3, .f3 = 4, .f4 = 5, .f5 = 6, .f6 = 7, .f7 = 8};
    kr_assert_eq(large.f0, 1);
    kr_assert_eq(large.f7, 8);
    kr_test_pass("Large tuple (8 elements)");
    KrTuple2 deep = (KrTuple2){.f0 = ({KrTuple2 _t = (KrTuple2){.f0 = ({KrTuple2 _t = (KrTuple2){.f0 = 1, .f1 = 2}; _kr_box(&_t, sizeof(KrTuple2));}), .f1 = 3}; _kr_box(&_t, sizeof(KrTuple2));}), .f1 = 4};
    KrTuple2 inner3 = *(KrTuple2*)(intptr_t)(deep.f0);
    KrTuple2 inner2 = *(KrTuple2*)(intptr_t)(inner3.f0);
    kr_assert_eq(inner2.f0, 1);
    kr_assert_eq(inner2.f1, 2);
    kr_assert_eq(inner3.f1, 3);
    kr_assert_eq(deep.f1, 4);
    kr_test_pass("Deeply nested tuples");
    KrTuple4 t1 = (KrTuple4){.f0 = 100, .f1 = 1, .f2 = 200, .f3 = 0};
    kr_assert_eq(t1.f0, 100);
    kr_assert_eq(t1.f1, 1);
    kr_assert_eq(t1.f2, 200);
    kr_assert_eq(t1.f3, 0);
    kr_test_pass("Multiple element tuples");
    KrTuple1 unit = (KrTuple1){.f0=0};
    kr_test_pass("Empty tuple (unit type)");
    KrTuple2 first = (KrTuple2){.f0 = 1, .f1 = 2};
    KrTuple2 second = (KrTuple2){.f0 = 3, .f1 = 4};
    kr_assert_eq(first.f0, 1);
    kr_assert_eq(second.f0, 3);
    kr_test_pass("Multiple tuple variables");
    KrTuple3 with_str = (KrTuple3){.f0 = 42, .f1 = "test", .f2 = 99};
    kr_assert_eq(with_str.f0, 42);
    kr_assert_eq(with_str.f2, 99);
    kr_test_pass("Tuple with string");
    KrTuple5 indexed = (KrTuple5){.f0 = 10, .f1 = 20, .f2 = 30, .f3 = 40, .f4 = 50};
    kr_assert_eq(indexed.f0, 10);
    kr_assert_eq(indexed.f1, 20);
    kr_assert_eq(indexed.f2, 30);
    kr_assert_eq(indexed.f3, 40);
    kr_assert_eq(indexed.f4, 50);
    ...
    KrTuple2 left = *(KrTuple2*)(intptr_t)(nested.f0);
    KrTuple2 right = *(KrTuple2*)(intptr_t)(nested.f1);
    kr_assert_eq(left.f0, 1);
    kr_assert_eq(left.f1, 2);
    kr_assert_eq(right.f0, 3);
    kr_assert_eq(right.f1, 4);
