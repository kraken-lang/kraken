...
static int64_t _kr_cl_274(void*, int64_t);
static int64_t _kr_cl_308(void*, int64_t);
static int64_t _kr_cl_342(void*, int64_t);
static int64_t _kr_cl_360(void*, int64_t);
static int64_t _kr_cl_421(void*, int64_t);
static int64_t _kr_cl_459(void*, int64_t);
static int64_t _kr_cl_499(void*, int64_t, int64_t);
static int64_t _kr_cl_522(void*, int64_t);
static int64_t _kr_cl_537(void*, int64_t);
static int64_t _kr_cl_563(void*, int64_t);
static int64_t _kr_cl_580(void*, int64_t, int64_t);
static int64_t _kr_cl_602(void*, int64_t, int64_t);
static int64_t _kr_cl_639(void*, int64_t);
static int64_t _kr_cl_654(void*, int64_t);
static int64_t _kr_cl_654(void* _env, int64_t x) {
    return x * 10;
}

static int64_t _kr_cl_639(void* _env, int64_t x) {
    return _KR_ADD(x, 10);
}

static int64_t _kr_cl_602(void* _env, int64_t x, int64_t y) {
    return x * y;
}

static int64_t _kr_cl_580(void* _env, int64_t x, int64_t y) {
    return _KR_ADD(x, y);
}

#define multiplier ((int64_t*)_env)[0]
#define kr_multiplier ((int64_t*)_env)[0]
static int64_t _kr_cl_563(void* _env, int64_t x) {
    return x * multiplier;
}
#undef multiplier
#undef kr_multiplier

static int64_t _kr_cl_537(void* _env, int64_t x) {
    return _KR_ADD(x, 2);
}

static int64_t _kr_cl_522(void* _env, int64_t x) {
    return x * 3;
}

static int64_t _kr_cl_499(void* _env, int64_t acc, int64_t x) {
...
static int64_t _kr_cl_421(void* _env, int64_t x) {
    return x * 2;
}

static int64_t _kr_cl_360(void* _env, int64_t x) {
    return _KR_ADD(x, 1);
}

static int64_t _kr_cl_342(void* _env, int64_t x) {
    return x * 2;
}

static int64_t _kr_cl_308(void* _env, int64_t x) {
    return _KR_ADD(x, 1);
}

static int64_t _kr_cl_274(void* _env, int64_t x) {
    return x * 2;
}
...
int64_t kr_apply_twice(int64_t x, void* f) {
    return ((int64_t(*)(void*, int64_t))_KR_CL_FN(f))(_KR_CL_ENV(f), ((int64_t(*)(void*, int64_t))_KR_CL_FN(f))(_KR_CL_ENV(f), x));
}

void* kr_compose(void* f, void* g) {
    return _kr_cl_alloc((void*)_kr_cl_85, 2, (int64_t)f, (int64_t)g);
}

void* kr_map_array(int64_t* arr, void* f) {
    int64_t* result = kr_vec_int_new();
    {
        __auto_type _kr_arr_134 = arr;
        for (int64_t _kr_i_134 = 0; _kr_i_134 < kr_vec_int_len(_kr_arr_134); _kr_i_134++) {
            __auto_type i = kr_vec_int_get(_kr_arr_134, _kr_i_134);
            kr_vec_int_push(result, ((int64_t(*)(void*, int64_t))_KR_CL_FN(f))(_KR_CL_ENV(f), i));
        }
    }
    return result;
}
...
void* kr_filter_array(int64_t* arr, void* predicate) {
    int64_t* result = kr_vec_int_new();
    {
        __auto_type _kr_arr_189 = arr;
        for (int64_t _kr_i_189 = 0; _kr_i_189 < kr_vec_int_len(_kr_arr_189); _kr_i_189++) {
            __auto_type i = kr_vec_int_get(_kr_arr_189, _kr_i_189);
            if (((int64_t(*)(void*, int64_t))_KR_CL_FN(predicate))(_KR_CL_ENV(predicate), i)) {
                kr_vec_int_push(result, i);
            }
        }
    }
    return result;
...
int64_t kr_reduce_array(int64_t* arr, int64_t initial, void* reducer) {
    ...
    {
        __auto_type _kr_arr_249 = arr;
        for (int64_t _kr_i_249 = 0; _kr_i_249 < kr_vec_int_len(_kr_arr_249); _kr_i_249++) {
            __auto_type i = kr_vec_int_get(_kr_arr_249, _kr_i_249);
            acc = ((int64_t(*)(void*, int64_t, int64_t))_KR_CL_FN(reducer))(_KR_CL_ENV(reducer), acc, i);
        }
    }
    return acc;
}
...
void kr_test_apply() {
    __auto_type double_val = _kr_cl_alloc((void*)_kr_cl_274, 0);
    __auto_type result = kr_apply(5, double_val);
}

void kr_test_apply_twice() {
    __auto_type increment = _kr_cl_alloc((void*)_kr_cl_308, 0);
    __auto_type result = kr_apply_twice(5, increment);
}

void kr_test_compose() {
    __auto_type double_val = _kr_cl_alloc((void*)_kr_cl_342, 0);
    __auto_type increment = _kr_cl_alloc((void*)_kr_cl_360, 0);
...
void kr_test_map() {
    ...
    __auto_type doubled = kr_map_array(arr, _kr_cl_alloc((void*)_kr_cl_421, 0));
}

void kr_test_filter() {
    __auto_type arr = _kr_vec_int_of(6, (int64_t)1, (int64_t)2, (int64_t)3, (int64_t)4, (int64_t)5, (int64_t)6);
    __auto_type evens = kr_filter_array(arr, _kr_cl_alloc((void*)_kr_cl_459, 0));
}

void kr_test_reduce() {
    __auto_type arr = _kr_vec_int_of(5, (int64_t)1, (int64_t)2, (int64_t)3, (int64_t)4, (int64_t)5);
    __auto_type sum = kr_reduce_array(arr, 0, _kr_cl_alloc((void*)_kr_cl_499, 0));
}

void kr_test_inline_closures() {
    __auto_type result1 = kr_apply(10, _kr_cl_alloc((void*)_kr_cl_522, 0));
    __auto_type result2 = kr_apply_twice(5, _kr_cl_alloc((void*)_kr_cl_537, 0));
}

void kr_test_closure_with_captures() {
    __auto_type multiplier = 3;
    __auto_type result = kr_apply(5, _kr_cl_alloc((void*)_kr_cl_563, 1, (int64_t)multiplier));
}

void kr_test_multiple_closures() {
    __auto_type add = _kr_cl_alloc((void*)_kr_cl_580, 0);
    __auto_type multiply = _kr_cl_alloc((void*)_kr_cl_602, 0);
    __auto_type arr = _kr_vec_int_of(3, (int64_t)1, (int64_t)2, (int64_t)3);
    __auto_type sums = kr_map_array(arr, _kr_cl_alloc((void*)_kr_cl_639, 0));
    __auto_type products = kr_map_array(arr, _kr_cl_alloc((void*)_kr_cl_654, 0));
}
