...
int64_t kr_apply(int64_t x, void* f, void* int_val, int64_t ), void* return, void* ), x apply_twice, f int_val, int64_t fn);
void kr_compose(void* f, void* int_val, void* ,, void* (, void* int_val, void* (, void* int_val, f x, x g);
...
void kr_test_map() {
    ...
    __auto_type doubled = kr_map_array(arr, |, |, *2);
}

void kr_test_filter() {
    __auto_type arr = (int64_t[]){1, 2, 3, 4, 5, 6};
    __auto_type evens = kr_filter_array(arr, |, |, _KR_EQ(%, ==), ), }, kr_test_reduce(), let, =[1], ,, ,, ,, ], let, =, (arr), 0, |, ,, |, +, ), }, kr_test_inline_closures(), let, =, (10), |, |, *3);
    __auto_type result2 = kr_apply_twice(5, |, |, +, ), }, kr_test_closure_with_captures(), let, =, ;, result, kr_apply(5, |, |, *multiplier), }, kr_test_multiple_closures(), let, = | x, int, y, int | ->, {, x + y, }, let, = | x, int, y, int | ->, {, x * y, }, let, =[1], ,, ], let, =, (arr), |, |, +, ), let, =, (arr), |, |, *10);
}
