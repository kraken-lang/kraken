...
void kr_main() {
    kr_test_section("Benchmark Demo");
    __auto_type start = kr_bench_start();
    __auto_type v = kr_vec_int_new();
    kr_vec_int_push(v, 1);
    kr_vec_int_push(v, 2);
    kr_vec_int_push(v, 3);
    kr_vec_int_free(v);
    kr_bench_end(start, "vec operations", 3);
    __auto_type start2 = kr_bench_start();
    __auto_type x1 = kr_math_abs(-42);
    __auto_type x2 = kr_math_abs(-100);
    __auto_type x3 = kr_math_sqrt(16.0);
    kr_bench_end(start2, "math operations", 3);
    kr_puts("Benchmark demo complete!");
}
