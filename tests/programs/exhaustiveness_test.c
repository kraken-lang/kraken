...
int64_t kr_test_exhaustive(Color c);
int64_t kr_test_non_exhaustive(Color c);
int64_t kr_main();
...
int64_t kr_main() {
    Color c = Color_Red;
    int64_t result = kr_test_exhaustive(c);
    kr_assert_eq(result, 1);
    int64_t result2 = kr_test_non_exhaustive(c);
    kr_assert_eq(result2, 1);
    kr_puts("Exhaustiveness tests passed");
    return 0;
}
