...
int64_t kr_single_param(int64_t x, ...);
int64_t kr_multi_param(int64_t a, int64_t b, kr_str c, ...);
int64_t kr_mixed_types(kr_str format, ...);
int64_t kr_main();
...
int64_t kr_main() {
    int64_t r1 = kr_single_param(42);
    int64_t r2 = kr_multi_param(10, 20, "test");
    int64_t r3 = kr_mixed_types("format");
    return _KR_ADD(_KR_ADD(r1, r2), r3);
}
