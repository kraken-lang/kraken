...
int64_t kr_test_modulo();
int64_t kr_test_logical();
int64_t kr_main();
...
int64_t kr_main() {
    __auto_type mod_result = kr_test_modulo();
    __auto_type logical_result = kr_test_logical();
    return _KR_ADD(mod_result, logical_result);
}
