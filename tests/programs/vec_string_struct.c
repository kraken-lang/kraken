...
int64_t kr_scan(kr_str source, void* kinds, void* lexemes, void* lines, void* cols);
int64_t kr_main();
...
int64_t kr_scan(kr_str source, void* kinds, void* lexemes, void* lines, void* cols) {
    ...
    while (!kr_pos_done(p)) {
        ...
        kr_vec_int_push(lines, 1);
        kr_vec_int_push(cols, p.idx);
        p = kr_pos_next(p);
...
int64_t kr_main() {
    ...
    __auto_type count = kr_scan("hello", kinds, lexemes, lines, cols);
    kr_puts(kr_str_concat("count: ", kr_fmt_int((int64_t)(intptr_t)(count))));
    __auto_type i = 0;
    while (i < count) {
        kr_puts(kr_str_concat(kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(kinds, i))), kr_str_concat(" col=", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(cols, i))))));
        i = _KR_ADD(i, 1);
    }
