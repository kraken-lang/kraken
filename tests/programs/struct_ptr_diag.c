...
int64_t kr_main() {
    ...
    Sp s = (Sp){.a = v};
    kr_puts(kr_str_concat("direct s.a[0]=", kr_fmt_int(kr_vec_int_get(s.a, 0))));
    int64_t inside_val = kr_check_inside(s);
    kr_puts(kr_str_concat("inside val=", kr_fmt_int(inside_val)));
    s = kr_identity(s);
    kr_puts(kr_str_concat("after return s.a[0]=", kr_fmt_int(kr_vec_int_get(s.a, 0))));
    kr_vec_int_free(v);
    return 0;
}
