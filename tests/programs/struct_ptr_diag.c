...
int64_t kr_check_inside(Sp s) {
    kr_vec_int_push(s.a, 99);
    int64_t val = kr_vec_int_get(s.a, 0);
    return val;
}
...
int64_t kr_main() {
    ...
    kr_vec_int_push(v, 42);
    Sp s = (Sp){.a = v};
    kr_puts(kr_str_concat("direct s.a[0]=", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(s.a, 0)))));
    int64_t inside_val = kr_check_inside(s);
    kr_puts(kr_str_concat("inside val=", kr_fmt_int((int64_t)(intptr_t)(inside_val))));
    s = kr_identity(s);
    kr_puts(kr_str_concat("after return s.a[0]=", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(s.a, 0)))));
    kr_vec_int_free(v);
    return 0;
}
