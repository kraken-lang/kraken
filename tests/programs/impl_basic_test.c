...
int64_t kr_main() {
    ...
    kr_puts(kr_str_concat("sum=", kr_fmt_int((int64_t)(intptr_t)(kr_Point_sum(p)))));
    Point q = kr_Point_scale(p, 10);
    kr_puts(kr_str_concat("scaled x=", kr_fmt_int((int64_t)(intptr_t)(q.x))));
    kr_puts(kr_str_concat("scaled y=", kr_fmt_int((int64_t)(intptr_t)(q.y))));
    kr_puts(kr_str_concat("scaled sum=", kr_fmt_int((int64_t)(intptr_t)(kr_Point_sum(q)))));
    return 0;
}
