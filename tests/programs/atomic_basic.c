...
int64_t kr_main() {
    uint8_t* counter = (uint8_t*)(intptr_t)(kr_atomic_new(0));
    kr_atomic_store(counter, 100);
    int64_t val = kr_atomic_load(counter);
    int64_t prev = kr_atomic_add(counter, 10);
    int64_t after_add = kr_atomic_load(counter);
    int64_t prev2 = kr_atomic_sub(counter, 5);
    int64_t after_sub = kr_atomic_load(counter);
    int64_t swapped = kr_atomic_cas(counter, 105, 200);
    int64_t final_val = kr_atomic_load(counter);
    return final_val - 200;
}
