...
void kr_main() {
    __auto_type abs_result = kr_math_abs(-42);
    kr_assert_eq(abs_result, 42);
    __auto_type abs_pos = kr_math_abs(10);
    kr_assert_eq(abs_pos, 10);
    __auto_type min_val = kr_math_min(5, 10);
    kr_assert_eq(min_val, 5);
    __auto_type max_val = kr_math_max(5, 10);
    kr_assert_eq(max_val, 10);
    __auto_type min_neg = kr_math_min(-5, -10);
    kr_assert_eq(min_neg, -10);
    __auto_type max_neg = kr_math_max(-5, -10);
    kr_assert_eq(max_neg, -5);
    __auto_type sqrt_result = kr_math_sqrt(16.0);
    __auto_type pow_result = kr_math_pow(2.0, 3.0);
    __auto_type floor_result = kr_math_floor(3.7);
    __auto_type ceil_result = kr_math_ceil(3.2);
    __auto_type round_result = kr_math_round(3.5);
    __auto_type sin_result = kr_math_sin(0.0);
    __auto_type cos_result = kr_math_cos(0.0);
    __auto_type tan_result = kr_math_tan(0.0);
    kr_puts("All math stdlib tests passed!");
}
