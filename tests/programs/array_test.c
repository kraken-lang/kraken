...
int64_t kr_sum_array();
int64_t kr_main();


int64_t kr_sum_array() {
    __auto_type arr = _kr_vec_int_of(5, (int64_t)10, (int64_t)20, (int64_t)30, (int64_t)40, (int64_t)50);
    __auto_type sum = _KR_ADD(_KR_ADD(_KR_ADD(_KR_ADD(kr_vec_int_get(arr, 0), kr_vec_int_get(arr, 1)), kr_vec_int_get(arr, 2)), kr_vec_int_get(arr, 3)), kr_vec_int_get(arr, 4));
    return sum;
}
