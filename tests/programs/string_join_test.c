...
int64_t kr_main() {
    __auto_type vec = kr_vec_string_new();
    kr_vec_string_push(vec, "hello");
    kr_vec_string_push(vec, "world");
    kr_vec_string_push(vec, "test");
    __auto_type joined = kr_str_join(vec, ", ");
    if (!kr_str_eq(joined, "hello, world, test")) {
        return 1;
    }
    __auto_type vec2 = kr_vec_string_new();
    kr_vec_string_push(vec2, "single");
    __auto_type joined2 = kr_str_join(vec2, ",");
    if (!kr_str_eq(joined2, "single")) {
        return 2;
    }
    __auto_type vec3 = kr_vec_string_new();
    __auto_type joined3 = kr_str_join(vec3, ",");
    if (!kr_str_eq(joined3, "")) {
        return 3;
    }
    __auto_type vec4 = kr_vec_string_new();
    kr_vec_string_push(vec4, "a");
    kr_vec_string_push(vec4, "b");
    kr_vec_string_push(vec4, "c");
    __auto_type joined4 = kr_str_join(vec4, "");
    if (!kr_str_eq(joined4, "abc")) {
        return 4;
    }
    return 0;
}
