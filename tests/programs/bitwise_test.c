...
int64_t kr_main() {
    __auto_type a = 12;
    __auto_type b = 10;
    __auto_type and_result = a & b;
    __auto_type or_result = a | b;
    __auto_type xor_result = a ^ b;
    __auto_type shift_left = 5 << 2;
    __auto_type shift_right = 20 >> 2;
    __auto_type not_result = ~5;
    kr_puts("Bitwise operations work!");
    return and_result;
}
