...
int64_t kr_print_drawable(KrDyn shape);
int64_t kr_main();
...
typedef struct { kr_str (*draw)(void*); int64_t (*area)(void*); } Drawable_VT;
static kr_str _kr_Circle_Drawable_draw_wrap(void* _self) { return kr_Circle_draw(*(Circle*)_self); }
static int64_t _kr_Circle_Drawable_area_wrap(void* _self) { return kr_Circle_area(*(Circle*)_self); }
static Drawable_VT _kr_Circle_Drawable_vt = { .draw = _kr_Circle_Drawable_draw_wrap, .area = _kr_Circle_Drawable_area_wrap };
static kr_str _kr_Rectangle_Drawable_draw_wrap(void* _self) { return kr_Rectangle_draw(*(Rectangle*)_self); }
static int64_t _kr_Rectangle_Drawable_area_wrap(void* _self) { return kr_Rectangle_area(*(Rectangle*)_self); }
static Drawable_VT _kr_Rectangle_Drawable_vt = { .draw = _kr_Rectangle_Drawable_draw_wrap, .area = _kr_Rectangle_Drawable_area_wrap };
