...
int64_t kr_main() {
    ...
    if (!kr_str_starts_with(s, "hello")) {
        return 1;
    }
    if (!kr_str_starts_with(s, "h")) {
        return 2;
    }
    if (!kr_str_starts_with(s, "hello world")) {
        return 3;
    }
    if (kr_str_starts_with(s, "world")) {
        return 4;
    }
    if (kr_str_starts_with(s, "xyz")) {
        return 5;
    }
    if (!kr_str_ends_with(s, "world")) {
        return 6;
    }
    if (!kr_str_ends_with(s, "d")) {
        return 7;
    }
    if (!kr_str_ends_with(s, "hello world")) {
        return 8;
    }
    if (kr_str_ends_with(s, "hello")) {
        return 9;
    }
    if (kr_str_ends_with(s, "xyz")) {
        return 10;
    }
    return 0;
}
