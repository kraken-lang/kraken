...
S2p kr_adv2p(S2p s) {
    return (S2p){.a = _KR_ADD(s.a, 1), .b = s.b};
}

S3p kr_adv3p(S3p s) {
    return (S3p){.a = _KR_ADD(s.a, 1), .b = s.b, .c = s.c};
}

S2pi kr_adv2pi(S2pi s) {
    return (S2pi){.a = s.a, .b = _KR_ADD(s.b, 1)};
}
...
int64_t kr_main() {
    ...
    kr_puts(kr_str_concat("S1p ok, val=", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(s1.a, 0)))));
    S2p s2 = (S2p){.a = 0, .b = v2};
    s2 = kr_adv2p(s2);
    kr_puts(kr_str_concat("S2p a=", kr_fmt_int((int64_t)(intptr_t)(s2.a))));
    kr_vec_int_push(s2.b, 22);
    kr_puts(kr_str_concat("S2p ok, val=", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(s2.b, 0)))));
    S3p s3 = (S3p){.a = 0, .b = 10, .c = v3};
    s3 = kr_adv3p(s3);
    kr_puts(kr_str_concat("S3p a=", kr_fmt_int((int64_t)(intptr_t)(s3.a))));
    kr_vec_int_push(s3.c, 33);
    kr_puts(kr_str_concat("S3p ok, val=", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(s3.c, 0)))));
    S2pi s2i = (S2pi){.a = v4, .b = 0};
    s2i = kr_adv2pi(s2i);
    kr_puts(kr_str_concat("S2pi b=", kr_fmt_int((int64_t)(intptr_t)(s2i.b))));
    kr_vec_int_push(s2i.a, 44);
    kr_puts(kr_str_concat("S2pi ok, val=", kr_fmt_int((int64_t)(intptr_t)(kr_vec_int_get(s2i.a, 0)))));
    kr_vec_int_free(v1);
    kr_vec_int_free(v2);
    kr_vec_int_free(v3);
    kr_vec_int_free(v4);
