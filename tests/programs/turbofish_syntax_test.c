...
int64_t kr_main() {
    ...
    failures = failures + kr_test_turbofish_function_call();
    failures = failures + kr_test_turbofish_multiple_params();
    failures = failures + kr_test_regular_syntax_still_works();
