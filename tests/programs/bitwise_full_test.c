...
int64_t kr_main() {
    kr_puts("Testing all bitwise operations:");
    __auto_type and_val = 12 & 10;
    __auto_type or_val = 12 | 10;
    __auto_type xor_val = 12 ^ 10;
    __auto_type shl_val = 5 << 2;
    __auto_type shr_val = 20 >> 2;
    __auto_type not_val = ~0;
    kr_puts("All bitwise operations successful!");
    return _KR_ADD(_KR_ADD(_KR_ADD(_KR_ADD(and_val, or_val), xor_val), shl_val), shr_val);
}
