...
void* kr_map(int64_t* arr, void* f);
void kr_test_map_basic();
void kr_test_map_transform();
void* kr_filter(int64_t* arr, void* predicate);
void kr_test_filter_basic();
void kr_test_filter_strings();
int64_t kr_fold(int64_t* arr, int64_t init, void* f);
...
void* kr_zip(int64_t* arr1, int64_t* arr2);
...
void* kr_flat_map(int64_t* arr, void* f);
void kr_test_flat_map();
KrTuple2 kr_partition(int64_t* arr, void* predicate);
...
static int64_t _kr_cl_85(void*, int64_t);
static int64_t _kr_cl_117(void*, int64_t);
static int64_t _kr_cl_219(void*, int64_t);
static int64_t _kr_cl_255(void*, int64_t);
static int64_t _kr_cl_353(void*, int64_t, int64_t);
static int64_t _kr_cl_391(void*, int64_t, int64_t);
static int64_t _kr_cl_427(void*, int64_t, int64_t);
static int64_t _kr_cl_475(void*, int64_t);
static int64_t _kr_cl_490(void*, int64_t);
static int64_t _kr_cl_530(void*, int64_t);
static int64_t _kr_cl_547(void*, int64_t);
static int64_t _kr_cl_564(void*, int64_t, int64_t);
static int64_t _kr_cl_748(void*, int64_t);
static int64_t _kr_cl_790(void*, int64_t);
static int64_t _kr_cl_822(void*, int64_t);
static int64_t _kr_cl_981(void*, int64_t);
static int64_t _kr_cl_1125(void*, int64_t);
static int64_t _kr_cl_1160(void*, int64_t);
static int64_t _kr_cl_1196(void*, int64_t);
static int64_t _kr_cl_1232(void*, int64_t);
static int64_t _kr_cl_1266(void*, int64_t);
static int64_t _kr_cl_1274(void*, int64_t);
static int64_t _kr_cl_1274(void* _env, int64_t y) {
    return _KR_ADD(y, 1);
}
...
static int64_t _kr_cl_1232(void* _env, int64_t x) {
    return x * 2;
}

static int64_t _kr_cl_1196(void* _env, int64_t x) {
    return _KR_ADD(x, 1);
}

static int64_t _kr_cl_1160(void* _env, int64_t x) {
    return x * 2;
}

static int64_t _kr_cl_1125(void* _env, int64_t x) {
    return _KR_EQ(x % 2, 0);
}

static int64_t _kr_cl_981(void* _env, int64_t x) {
    return _kr_vec_int_of(2, (int64_t)x, (int64_t)x * 10);
}

#define n ((int64_t*)_env)[0]
#define kr_n ((int64_t*)_env)[0]
static int64_t _kr_cl_822(void* _env, int64_t x) {
    return _KR_ADD(x, n);
}
#undef n
#undef kr_n

#define scale ((int64_t*)_env)[0]
#define kr_scale ((int64_t*)_env)[0]
#define offset ((int64_t*)_env)[1]
#define kr_offset ((int64_t*)_env)[1]
static int64_t _kr_cl_790(void* _env, int64_t x) {
    return _KR_ADD((x * scale), offset);
}
#undef scale
#undef kr_scale
#undef offset
...
static int64_t _kr_cl_748(void* _env, int64_t x) {
    return x * multiplier;
}
#undef multiplier
#undef kr_multiplier

static int64_t _kr_cl_564(void* _env, int64_t acc, int64_t x) {
    return _KR_ADD(acc, x);
}

static int64_t _kr_cl_547(void* _env, int64_t x) {
    return x * 2;
}

static int64_t _kr_cl_530(void* _env, int64_t x) {
    return _KR_EQ(x % 2, 0);
}

static int64_t _kr_cl_490(void* _env, int64_t x) {
    return _KR_EQ(x % 2, 0);
}

static int64_t _kr_cl_475(void* _env, int64_t x) {
    return x * x;
}

static int64_t _kr_cl_427(void* _env, int64_t acc, int64_t word) {
    return _KR_ADD(acc, word);
}

static int64_t _kr_cl_391(void* _env, int64_t acc, int64_t x) {
    return acc * x;
}

static int64_t _kr_cl_353(void* _env, int64_t acc, int64_t x) {
    return _KR_ADD(acc, x);
}

static int64_t _kr_cl_255(void* _env, int64_t w) {
    return _KR_LEN(w) > 3;
}

static int64_t _kr_cl_219(void* _env, int64_t x) {
    return _KR_EQ(x % 2, 0);
}

static int64_t _kr_cl_117(void* _env, int64_t x) {
    return _KR_ADD("Number: ", _KR_TO_STRING(x));
}

static int64_t _kr_cl_85(void* _env, int64_t x) {
    return x * 2;
}

void* kr_map(int64_t* arr, void* f) {
    int64_t* result = kr_vec_int_new();
    {
        __auto_type _kr_arr_41 = arr;
        for (int64_t _kr_i_41 = 0; _kr_i_41 < kr_vec_int_len(_kr_arr_41); _kr_i_41++) {
            __auto_type item = kr_vec_int_get(_kr_arr_41, _kr_i_41);
            kr_vec_int_push(result, ((int64_t(*)(void*, int64_t))_KR_CL_FN(f))(_KR_CL_ENV(f), item));
        }
    }
    return result;
}
...
void kr_test_map_basic() {
    __auto_type numbers = _kr_vec_int_of(5, (int64_t)1, (int64_t)2, (int64_t)3, (int64_t)4, (int64_t)5);
    __auto_type doubled = kr_map(numbers, _kr_cl_alloc((void*)_kr_cl_85, 0));
}

void kr_test_map_transform() {
    __auto_type numbers = _kr_vec_int_of(3, (int64_t)1, (int64_t)2, (int64_t)3);
    __auto_type strings = kr_map(numbers, _kr_cl_alloc((void*)_kr_cl_117, 0));
}

void* kr_filter(int64_t* arr, void* predicate) {
    int64_t* result = kr_vec_int_new();
    {
        __auto_type _kr_arr_169 = arr;
        for (int64_t _kr_i_169 = 0; _kr_i_169 < kr_vec_int_len(_kr_arr_169); _kr_i_169++) {
            __auto_type item = kr_vec_int_get(_kr_arr_169, _kr_i_169);
            if (((int64_t(*)(void*, int64_t))_KR_CL_FN(predicate))(_KR_CL_ENV(predicate), item)) {
                kr_vec_int_push(result, item);
            }
        }
    }
    return result;
...
void kr_test_filter_basic() {
    __auto_type numbers = _kr_vec_int_of(6, (int64_t)1, (int64_t)2, (int64_t)3, (int64_t)4, (int64_t)5, (int64_t)6);
    __auto_type evens = kr_filter(numbers, _kr_cl_alloc((void*)_kr_cl_219, 0));
}

void kr_test_filter_strings() {
    __auto_type words = _kr_vec_string_of(4, "hello", "world", "test", "hi");
    __auto_type long_words = kr_filter(words, _kr_cl_alloc((void*)_kr_cl_255, 0));
}

int64_t kr_fold(int64_t* arr, int64_t init, void* f) {
    __auto_type acc = init;
    {
        __auto_type _kr_arr_308 = arr;
        for (int64_t _kr_i_308 = 0; _kr_i_308 < kr_vec_int_len(_kr_arr_308); _kr_i_308++) {
            __auto_type item = kr_vec_int_get(_kr_arr_308, _kr_i_308);
            acc = ((int64_t(*)(void*, int64_t, int64_t))_KR_CL_FN(f))(_KR_CL_ENV(f), acc, item);
        }
    }
    return acc;
}
...
void kr_test_fold_sum() {
    __auto_type numbers = _kr_vec_int_of(5, (int64_t)1, (int64_t)2, (int64_t)3, (int64_t)4, (int64_t)5);
    __auto_type sum = kr_fold(numbers, 0, _kr_cl_alloc((void*)_kr_cl_353, 0));
}

void kr_test_fold_product() {
    __auto_type numbers = _kr_vec_int_of(4, (int64_t)1, (int64_t)2, (int64_t)3, (int64_t)4);
    __auto_type product = kr_fold(numbers, 1, _kr_cl_alloc((void*)_kr_cl_391, 0));
}

void kr_test_fold_string_concat() {
    __auto_type words = _kr_vec_string_of(3, "Hello", " ", "World");
    __auto_type sentence = kr_fold(words, "", _kr_cl_alloc((void*)_kr_cl_427, 0));
}

void kr_test_chain_map_filter() {
    __auto_type numbers = _kr_vec_int_of(10, (int64_t)1, (int64_t)2, (int64_t)3, (int64_t)4, (int64_t)5, (int64_t)6, (int64_t)7, (int64_t)8, (int64_t)9, (int64_t)10);
    __auto_type squared = kr_map(numbers, _kr_cl_alloc((void*)_kr_cl_475, 0));
    __auto_type even_squares = kr_filter(squared, _kr_cl_alloc((void*)_kr_cl_490, 0));
}

void kr_test_chain_filter_map_fold() {
    __auto_type numbers = _kr_vec_int_of(6, (int64_t)1, (int64_t)2, (int64_t)3, (int64_t)4, (int64_t)5, (int64_t)6);
    __auto_type evens = kr_filter(numbers, _kr_cl_alloc((void*)_kr_cl_530, 0));
    __auto_type doubled = kr_map(evens, _kr_cl_alloc((void*)_kr_cl_547, 0));
    __auto_type sum = kr_fold(doubled, 0, _kr_cl_alloc((void*)_kr_cl_564, 0));
}

void* kr_zip(int64_t* arr1, int64_t* arr2) {
    int64_t* result = kr_vec_int_new();
    __auto_type len = (kr_vec_int_len(arr1) < kr_vec_int_len(arr2)) ? (kr_vec_int_len(arr1)) : (kr_vec_int_len(arr2));
    for (int64_t i = 0; i < len; i++) {
        kr_vec_int_push(result, (int64_t)(intptr_t)_kr_box(&(KrTuple2){.f0 = kr_vec_int_get(arr1, i), .f1 = kr_vec_int_get(arr2, i)}, sizeof(KrTuple2)));
    }
    return result;
}
...
void kr_test_zip_basic() {
    __auto_type numbers = _kr_vec_int_of(3, (int64_t)1, (int64_t)2, (int64_t)3);
    __auto_type letters = _kr_vec_string_of(3, "a", "b", "c");
...
void kr_test_closure_capture_generic() {
    ...
    __auto_type numbers = _kr_vec_int_of(5, (int64_t)1, (int64_t)2, (int64_t)3, (int64_t)4, (int64_t)5);
    __auto_type result = kr_map(numbers, _kr_cl_alloc((void*)_kr_cl_748, 1, (int64_t)multiplier));
}
...
void kr_test_closure_capture_multiple() {
    ...
    __auto_type scale = 2;
    __auto_type numbers = _kr_vec_int_of(3, (int64_t)1, (int64_t)2, (int64_t)3);
    __auto_type result = kr_map(numbers, _kr_cl_alloc((void*)_kr_cl_790, 2, (int64_t)scale, (int64_t)offset));
}

void* kr_make_adder(int64_t n) {
    return _kr_cl_alloc((void*)_kr_cl_822, 1, (int64_t)n);
}

void kr_test_make_adder() {
    __auto_type add5 = kr_make_adder(5);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add5))(_KR_CL_ENV(add5), 10);
}
...
void* kr_flat_map(int64_t* arr, void* f) {
    int64_t* result = kr_vec_int_new();
    {
        __auto_type _kr_arr_930 = arr;
        for (int64_t _kr_i_930 = 0; _kr_i_930 < kr_vec_int_len(_kr_arr_930); _kr_i_930++) {
            __auto_type item = kr_vec_int_get(_kr_arr_930, _kr_i_930);
            __auto_type mapped = ((int64_t(*)(void*, int64_t))_KR_CL_FN(f))(_KR_CL_ENV(f), item);
            {
                __auto_type _kr_arr_943 = mapped;
                for (int64_t _kr_i_943 = 0; _kr_i_943 < kr_vec_int_len(_kr_arr_943); _kr_i_943++) {
                    __auto_type elem = kr_vec_int_get(_kr_arr_943, _kr_i_943);
                    kr_vec_int_push(result, elem);
                }
            }
        }
    }
...
void kr_test_flat_map() {
    __auto_type numbers = _kr_vec_int_of(3, (int64_t)1, (int64_t)2, (int64_t)3);
    __auto_type result = kr_flat_map(numbers, _kr_cl_alloc((void*)_kr_cl_981, 0));
}

KrTuple2 kr_partition(int64_t* arr, void* predicate) {
    int64_t* true_arr = kr_vec_int_new();
    int64_t* false_arr = kr_vec_int_new();
    {
        __auto_type _kr_arr_1049 = arr;
        for (int64_t _kr_i_1049 = 0; _kr_i_1049 < kr_vec_int_len(_kr_arr_1049); _kr_i_1049++) {
            __auto_type item = kr_vec_int_get(_kr_arr_1049, _kr_i_1049);
            if (((int64_t(*)(void*, int64_t))_KR_CL_FN(predicate))(_KR_CL_ENV(predicate), item)) {
                kr_vec_int_push(true_arr, item);
            }
            else {
                kr_vec_int_push(false_arr, item);
            }
        }
    }
    return (KrTuple2){.f0 = true_arr, .f1 = false_arr};
}

void kr_test_partition() {
    __auto_type numbers = _kr_vec_int_of(10, (int64_t)1, (int64_t)2, (int64_t)3, (int64_t)4, (int64_t)5, (int64_t)6, (int64_t)7, (int64_t)8, (int64_t)9, (int64_t)10);
    KrTuple2 _kr_tup_1121 = kr_partition(numbers, _kr_cl_alloc((void*)_kr_cl_1125, 0));
    __auto_type evens = _kr_tup_1121.f0;
    __auto_type odds = _kr_tup_1121.f1;
}

void kr_test_move_closure_generic() {
    __auto_type data = _kr_vec_int_of(3, (int64_t)1, (int64_t)2, (int64_t)3);
    __auto_type result = kr_map(data, _kr_cl_alloc((void*)_kr_cl_1160, 0));
}

void kr_test_inference_from_return() {
    __auto_type numbers = _kr_vec_int_of(3, (int64_t)1, (int64_t)2, (int64_t)3);
    int64_t* result = kr_map(numbers, _kr_cl_alloc((void*)_kr_cl_1196, 0));
}

void kr_test_inference_from_argument() {
    int64_t* numbers = _kr_vec_int_of(3, (int64_t)1, (int64_t)2, (int64_t)3);
    __auto_type result = kr_map(numbers, _kr_cl_alloc((void*)_kr_cl_1232, 0));
}

void kr_test_inference_nested() {
    __auto_type numbers = _kr_vec_int_of(3, (int64_t)1, (int64_t)2, (int64_t)3);
    __auto_type result = kr_map(kr_map(numbers, _kr_cl_alloc((void*)_kr_cl_1266, 0)), _kr_cl_alloc((void*)_kr_cl_1274, 0));
}
