...
static void* _kr_cl_8(void*, int64_t);
static int64_t _kr_cl_22(void*, int64_t);
static void* _kr_cl_56(void*, int64_t);
static int64_t _kr_cl_75(void*, int64_t);
static int64_t _kr_cl_80(void*, int64_t);
static void* _kr_cl_131(void*, int64_t);
static int64_t _kr_cl_147(void*, int64_t);
static void* _kr_cl_194(void*, int64_t);
static int64_t _kr_cl_208(void*, int64_t);
static int64_t _kr_cl_215(void*, int64_t);
static void* _kr_cl_267(void*);
static int64_t _kr_cl_282(void*);
static KrTuple2 _kr_cl_348(void*, int64_t);
static int64_t _kr_cl_373(void*, int64_t);
static int64_t _kr_cl_391(void*, int64_t);
static int64_t _kr_cl_484(void*, int64_t);
static void* _kr_cl_549(void*, bool);
static int64_t _kr_cl_568(void*, int64_t);
static int64_t _kr_cl_579(void*, int64_t);
static void* _kr_cl_630(void*);
static int64_t _kr_cl_642(void*, int64_t);
static void* _kr_cl_698(void*, int64_t);
static int64_t _kr_cl_717(void*, int64_t);
static int64_t _kr_cl_722(void*, int64_t);
static void* _kr_cl_767(void*, int64_t);
static int64_t _kr_cl_786(void*, int64_t);
static void* _kr_cl_824(void*, void*, void*);
static int64_t _kr_cl_852(void*, int64_t);
static int64_t _kr_cl_868(void*, int64_t);
static int64_t _kr_cl_886(void*, int64_t);
static void* _kr_cl_928(void*, int64_t);
static int64_t _kr_cl_942(void*, int64_t);
static int64_t _kr_cl_1013(void*);
static int64_t _kr_cl_1023(void*);
static int64_t _kr_cl_1033(void*);
static int64_t _kr_cl_1043(void*);
static void* _kr_cl_1098(void*, int64_t);
static int64_t _kr_cl_1117(void*, int64_t);
#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
#define offset ((int64_t*)_env)[1]
#define kr_offset ((int64_t*)_env)[1]
#define multiplier ((int64_t*)_env)[2]
#define kr_multiplier ((int64_t*)_env)[2]
static int64_t _kr_cl_1117(void* _env, int64_t y) {
    return (_KR_ADD(_KR_ADD(x, y), offset)) * multiplier;
}
#undef x
#undef kr_x
#undef offset
...
#define multiplier ((int64_t*)_env)[0]
#define kr_multiplier ((int64_t*)_env)[0]
static void* _kr_cl_1098(void* _env, int64_t x) {
    __auto_type offset = 10;
    return _kr_cl_alloc((void*)_kr_cl_1117, 3, (int64_t)x, (int64_t)offset, (int64_t)multiplier);
}
#undef multiplier
#undef kr_multiplier
...
static int64_t _kr_cl_1043(void* _env) {
    return _KR_ADD(_KR_ADD(_KR_ADD(a, b), c), d);
}
#undef a
#undef kr_a
#undef b
...
#define c ((int64_t*)_env)[2]
#define kr_c ((int64_t*)_env)[2]
static int64_t _kr_cl_1033(void* _env) {
    __auto_type d = 4;
    __auto_type f4 = _kr_cl_alloc((void*)_kr_cl_1043, 4, (int64_t)a, (int64_t)b, (int64_t)c, (int64_t)d);
    return ((int64_t(*)(void*))_KR_CL_FN(f4))(_KR_CL_ENV(f4));
}
#undef a
#undef kr_a
#undef b
...
#define b ((int64_t*)_env)[1]
#define kr_b ((int64_t*)_env)[1]
static int64_t _kr_cl_1023(void* _env) {
    __auto_type c = 3;
    __auto_type f3 = _kr_cl_alloc((void*)_kr_cl_1033, 3, (int64_t)a, (int64_t)b, (int64_t)c);
    return ((int64_t(*)(void*))_KR_CL_FN(f3))(_KR_CL_ENV(f3));
}
#undef a
#undef kr_a
#undef b
...
#define a ((int64_t*)_env)[0]
#define kr_a ((int64_t*)_env)[0]
static int64_t _kr_cl_1013(void* _env) {
    __auto_type b = 2;
    __auto_type f2 = _kr_cl_alloc((void*)_kr_cl_1023, 2, (int64_t)a, (int64_t)b);
    return ((int64_t(*)(void*))_KR_CL_FN(f2))(_KR_CL_ENV(f2));
}
#undef a
#undef kr_a
...
#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_942(void* _env, int64_t y) {
    return _KR_ADD(x, y);
}
#undef x
#undef kr_x

static void* _kr_cl_928(void* _env, int64_t x) {
    return _kr_cl_alloc((void*)_kr_cl_942, 1, (int64_t)x);
}

static int64_t _kr_cl_886(void* _env, int64_t x) {
    return _KR_ADD(x, 1);
}

static int64_t _kr_cl_868(void* _env, int64_t x) {
    return x * 2;
}

#define f ((int64_t*)_env)[0]
#define kr_f ((int64_t*)_env)[0]
#define g ((int64_t*)_env)[1]
#define kr_g ((int64_t*)_env)[1]
static int64_t _kr_cl_852(void* _env, int64_t x) {
    return ((int64_t(*)(void*, int64_t))_KR_CL_FN(f))(_KR_CL_ENV(f), ((int64_t(*)(void*, int64_t))_KR_CL_FN(g))(_KR_CL_ENV(g), x));
}
#undef f
#undef kr_f
#undef g
...
static void* _kr_cl_824(void* _env, void* f, void* g) {
    return _kr_cl_alloc((void*)_kr_cl_852, 2, (int64_t)f, (int64_t)g);
}

#define global ((int64_t*)_env)[0]
#define kr_global ((int64_t*)_env)[0]
#define x ((int64_t*)_env)[1]
#define kr_x ((int64_t*)_env)[1]
#define local ((int64_t*)_env)[2]
#define kr_local ((int64_t*)_env)[2]
static int64_t _kr_cl_786(void* _env, int64_t y) {
    return _KR_ADD(_KR_ADD(_KR_ADD(global, x), local), y);
}
#undef global
#undef kr_global
#undef x
...
#define global ((int64_t*)_env)[0]
#define kr_global ((int64_t*)_env)[0]
static void* _kr_cl_767(void* _env, int64_t x) {
    __auto_type local = 10;
    return _kr_cl_alloc((void*)_kr_cl_786, 3, (int64_t)global, (int64_t)x, (int64_t)local);
}
#undef global
#undef kr_global
...
#define b ((int64_t*)_env)[1]
#define kr_b ((int64_t*)_env)[1]
static int64_t _kr_cl_722(void* _env, int64_t c) {
    return _KR_ADD(_KR_ADD(a, b), c);
}
#undef a
#undef kr_a
#undef b
...
#define a ((int64_t*)_env)[0]
#define kr_a ((int64_t*)_env)[0]
static int64_t _kr_cl_717(void* _env, int64_t b) {
    return _kr_cl_alloc((void*)_kr_cl_722, 2, (int64_t)a, (int64_t)b);
}
#undef a
#undef kr_a

static void* _kr_cl_698(void* _env, int64_t a) {
    return _kr_cl_alloc((void*)_kr_cl_717, 1, (int64_t)a);
}

static int64_t _kr_cl_642(void* _env, int64_t n) {
    if (n <= 1) {
        return 1;
    }
    else {
...
static void* _kr_cl_630(void* _env) {
    __auto_type factorial = _kr_cl_alloc((void*)_kr_cl_642, 0);
    return factorial;
}

static int64_t _kr_cl_579(void* _env, int64_t x) {
    return _KR_ADD(x, 2);
}

static int64_t _kr_cl_568(void* _env, int64_t x) {
    return x * 2;
}

static void* _kr_cl_549(void* _env, bool flag) {
    if (flag) {
        return _kr_cl_alloc((void*)_kr_cl_568, 0);
    }
    else {
        return _kr_cl_alloc((void*)_kr_cl_579, 0);
    }
}

#define i ((int64_t*)_env)[0]
#define kr_i ((int64_t*)_env)[0]
static int64_t _kr_cl_484(void* _env, int64_t x) {
    return x * i;
}
#undef i
#undef kr_i
...
#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_391(void* _env, int64_t y) {
    return x * y;
}
#undef x
#undef kr_x
...
#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_373(void* _env, int64_t y) {
    return _KR_ADD(x, y);
}
#undef x
#undef kr_x

static KrTuple2 _kr_cl_348(void* _env, int64_t x) {
    __auto_type add = _kr_cl_alloc((void*)_kr_cl_373, 1, (int64_t)x);
    __auto_type mul = _kr_cl_alloc((void*)_kr_cl_391, 1, (int64_t)x);
    return (KrTuple2){.f0 = add, .f1 = mul};
}

#define count ((int64_t*)_env)[0]
#define kr_count ((int64_t*)_env)[0]
static int64_t _kr_cl_282(void* _env) {
...
static void* _kr_cl_267(void* _env) {
    __auto_type count = 0;
    return _kr_cl_alloc((void*)_kr_cl_282, 1, (int64_t)count);
}

static int64_t _kr_cl_215(void* _env, int64_t y) {
    return y * 2;
}

#define factor ((int64_t*)_env)[0]
#define kr_factor ((int64_t*)_env)[0]
static int64_t _kr_cl_208(void* _env, int64_t x) {
    __auto_type double_val = _kr_cl_alloc((void*)_kr_cl_215, 0);
    return ((int64_t(*)(void*, int64_t))_KR_CL_FN(double_val))(_KR_CL_ENV(double_val), x) * factor;
}
#undef factor
#undef kr_factor

static void* _kr_cl_194(void* _env, int64_t factor) {
    return _kr_cl_alloc((void*)_kr_cl_208, 1, (int64_t)factor);
}
...
#define b ((int64_t*)_env)[1]
#define kr_b ((int64_t*)_env)[1]
static int64_t _kr_cl_147(void* _env, int64_t c) {
    return _KR_ADD(_KR_ADD(a, b), c);
}
#undef a
#undef kr_a
...
#define a ((int64_t*)_env)[0]
#define kr_a ((int64_t*)_env)[0]
static void* _kr_cl_131(void* _env, int64_t b) {
    __auto_type inner = _kr_cl_alloc((void*)_kr_cl_147, 2, (int64_t)a, (int64_t)b);
    return inner;
}
#undef a
#undef kr_a
...
static int64_t _kr_cl_80(void* _env, int64_t z) {
    return _KR_ADD(_KR_ADD(x, y), z);
}
#undef x
#undef kr_x
#undef y
...
#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_75(void* _env, int64_t y) {
    return _kr_cl_alloc((void*)_kr_cl_80, 2, (int64_t)x, (int64_t)y);
}
#undef x
#undef kr_x

static void* _kr_cl_56(void* _env, int64_t x) {
    return _kr_cl_alloc((void*)_kr_cl_75, 1, (int64_t)x);
}

#define x ((int64_t*)_env)[0]
#define kr_x ((int64_t*)_env)[0]
static int64_t _kr_cl_22(void* _env, int64_t y) {
    return _KR_ADD(x, y);
}
#undef x
#undef kr_x

static void* _kr_cl_8(void* _env, int64_t x) {
    return _kr_cl_alloc((void*)_kr_cl_22, 1, (int64_t)x);
}

void kr_test_simple_nested() {
    __auto_type outer = _kr_cl_alloc((void*)_kr_cl_8, 0);
    __auto_type add5 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(outer))(_KR_CL_ENV(outer), 5);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add5))(_KR_CL_ENV(add5), 3);
}

void kr_test_double_nested() {
    __auto_type outer = _kr_cl_alloc((void*)_kr_cl_56, 0);
    __auto_type f1 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(outer))(_KR_CL_ENV(outer), 1);
    __auto_type f2 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(f1))(_KR_CL_ENV(f1), 2);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(f2))(_KR_CL_ENV(f2), 3);
}

void kr_test_nested_with_captures() {
    __auto_type a = 10;
    __auto_type outer = _kr_cl_alloc((void*)_kr_cl_131, 1, (int64_t)a);
    __auto_type f = ((int64_t(*)(void*, int64_t))_KR_CL_FN(outer))(_KR_CL_ENV(outer), 20);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(f))(_KR_CL_ENV(f), 30);
}

void kr_test_nested_closure_chain() {
    __auto_type make_multiplier = _kr_cl_alloc((void*)_kr_cl_194, 0);
    __auto_type triple = ((int64_t(*)(void*, int64_t))_KR_CL_FN(make_multiplier))(_KR_CL_ENV(make_multiplier), 3);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(triple))(_KR_CL_ENV(triple), 5);
}

void kr_test_nested_with_state() {
    __auto_type make_counter = _kr_cl_alloc((void*)_kr_cl_267, 0);
    __auto_type counter1 = ((int64_t(*)(void*))_KR_CL_FN(make_counter))(_KR_CL_ENV(make_counter));
    __auto_type counter2 = ((int64_t(*)(void*))_KR_CL_FN(make_counter))(_KR_CL_ENV(make_counter));
    __auto_type r1 = ((int64_t(*)(void*))_KR_CL_FN(counter1))(_KR_CL_ENV(counter1));
    __auto_type r2 = ((int64_t(*)(void*))_KR_CL_FN(counter1))(_KR_CL_ENV(counter1));
    __auto_type r3 = ((int64_t(*)(void*))_KR_CL_FN(counter2))(_KR_CL_ENV(counter2));
    __auto_type r4 = ((int64_t(*)(void*))_KR_CL_FN(counter1))(_KR_CL_ENV(counter1));
}

void kr_test_nested_returning_multiple() {
    __auto_type make_ops = _kr_cl_alloc((void*)_kr_cl_348, 0);
    KrTuple2 _kr_tup_422 = ((KrTuple2(*)(void*, int64_t))_KR_CL_FN(make_ops))(_KR_CL_ENV(make_ops), 5);
    __auto_type add5 = _kr_tup_422.f0;
    __auto_type mul5 = _kr_tup_422.f1;
    __auto_type r1 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add5))(_KR_CL_ENV(add5), 3);
    __auto_type r2 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(mul5))(_KR_CL_ENV(mul5), 3);
}

void kr_test_nested_in_loop() {
    int64_t* closures = kr_vec_int_new();
    {
        __auto_type _kr_arr_468 = _kr_vec_int_of(5, (int64_t)1, (int64_t)2, (int64_t)3, (int64_t)4, (int64_t)5);
        for (int64_t _kr_i_468 = 0; _kr_i_468 < kr_vec_int_len(_kr_arr_468); _kr_i_468++) {
            __auto_type i = kr_vec_int_get(_kr_arr_468, _kr_i_468);
            __auto_type closure = _kr_cl_alloc((void*)_kr_cl_484, 1, (int64_t)i);
            kr_vec_int_push(closures, closure);
        }
    }
    __auto_type r1 = _kr_cl_call1((void*)kr_vec_int_get(closures, 0), 10);
    __auto_type r2 = _kr_cl_call1((void*)kr_vec_int_get(closures, 2), 10);
    __auto_type r3 = _kr_cl_call1((void*)kr_vec_int_get(closures, 4), 10);
}

void kr_test_nested_conditional() {
    __auto_type make_conditional = _kr_cl_alloc((void*)_kr_cl_549, 0);
    __auto_type double_val = ((int64_t(*)(void*, int64_t))_KR_CL_FN(make_conditional))(_KR_CL_ENV(make_conditional), true);
    __auto_type add2 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(make_conditional))(_KR_CL_ENV(make_conditional), false);
    __auto_type r1 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(double_val))(_KR_CL_ENV(double_val), 5);
    __auto_type r2 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add2))(_KR_CL_ENV(add2), 5);
}

void kr_test_nested_recursive_style() {
    __auto_type make_factorial = _kr_cl_alloc((void*)_kr_cl_630, 0);
    __auto_type fact = ((int64_t(*)(void*))_KR_CL_FN(make_factorial))(_KR_CL_ENV(make_factorial));
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(fact))(_KR_CL_ENV(fact), 5);
}

void kr_test_triple_nested() {
    __auto_type level1 = _kr_cl_alloc((void*)_kr_cl_698, 0);
    __auto_type result = _kr_cl_call1((void*)_kr_cl_call1((void*)((int64_t(*)(void*, int64_t))_KR_CL_FN(level1))(_KR_CL_ENV(level1), 1), 2), 3);
}

void kr_test_nested_with_mixed_captures() {
    __auto_type global = 100;
    __auto_type outer = _kr_cl_alloc((void*)_kr_cl_767, 1, (int64_t)global);
    __auto_type f = ((int64_t(*)(void*, int64_t))_KR_CL_FN(outer))(_KR_CL_ENV(outer), 5);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(f))(_KR_CL_ENV(f), 1);
}

void kr_test_nested_closure_composition() {
    __auto_type compose = _kr_cl_alloc((void*)_kr_cl_824, 0);
    __auto_type double_val = _kr_cl_alloc((void*)_kr_cl_868, 0);
    __auto_type increment = _kr_cl_alloc((void*)_kr_cl_886, 0);
    __auto_type composed = ((int64_t(*)(void*, int64_t, int64_t))_KR_CL_FN(compose))(_KR_CL_ENV(compose), double_val, increment);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(composed))(_KR_CL_ENV(composed), 5);
}

void kr_test_nested_partial_application() {
    __auto_type add = _kr_cl_alloc((void*)_kr_cl_928, 0);
    __auto_type add1 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add))(_KR_CL_ENV(add), 1);
    __auto_type add2 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add))(_KR_CL_ENV(add), 2);
    __auto_type add10 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add))(_KR_CL_ENV(add), 10);
    __auto_type r1 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add1))(_KR_CL_ENV(add1), 5);
    __auto_type r2 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add2))(_KR_CL_ENV(add2), 5);
    __auto_type r3 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(add10))(_KR_CL_ENV(add10), 5);
}

void kr_test_deeply_nested_captures() {
    __auto_type a = 1;
    __auto_type f1 = _kr_cl_alloc((void*)_kr_cl_1013, 1, (int64_t)a);
    __auto_type result = ((int64_t(*)(void*))_KR_CL_FN(f1))(_KR_CL_ENV(f1));
}

void kr_test_nested_with_parameters_and_captures() {
    __auto_type multiplier = 3;
    __auto_type outer = _kr_cl_alloc((void*)_kr_cl_1098, 1, (int64_t)multiplier);
    __auto_type f = ((int64_t(*)(void*, int64_t))_KR_CL_FN(outer))(_KR_CL_ENV(outer), 5);
    __auto_type result = ((int64_t(*)(void*, int64_t))_KR_CL_FN(f))(_KR_CL_ENV(f), 2);
}
