...
typedef struct { int64_t (*area)(void*); } Shape_VT;
static int64_t _kr_Circle_Shape_area_wrap(void* _self) { return kr_Circle_area(*(Circle*)_self); }
static Shape_VT _kr_Circle_Shape_vt = { .area = _kr_Circle_Shape_area_wrap };
static int64_t _kr_Rect_Shape_area_wrap(void* _self) { return kr_Rect_area(*(Rect*)_self); }
static Shape_VT _kr_Rect_Shape_vt = { .area = _kr_Rect_Shape_area_wrap };
...
int64_t kr_print_area(KrDyn s) {
    return ((Shape_VT*)s.vtable)->area(s.data);
}

int64_t kr_main() {
    __auto_type c = (Circle){.radius = 10};
    __auto_type r = (Rect){.width = 20, .height = 10};
    Circle _dyn_tmp_dc = c;
    KrDyn dc = (KrDyn){ .data = malloc(sizeof(Circle)), .vtable = &_kr_Circle_Shape_vt };
    memcpy(dc.data, &_dyn_tmp_dc, sizeof(Circle));
    Rect _dyn_tmp_dr = r;
    KrDyn dr = (KrDyn){ .data = malloc(sizeof(Rect)), .vtable = &_kr_Rect_Shape_vt };
    memcpy(dr.data, &_dyn_tmp_dr, sizeof(Rect));
    kr_puts(kr_str_concat("circle area: ", kr_fmt_int((int64_t)(intptr_t)(((Shape_VT*)dc.vtable)->area(dc.data)))));
    kr_puts(kr_str_concat("rect area: ", kr_fmt_int((int64_t)(intptr_t)(((Shape_VT*)dr.vtable)->area(dr.data)))));
