...
int64_t kr_main() {
    kr_str s1 = (kr_str)(intptr_t)("hello");
    kr_str s2 = (kr_str)(intptr_t)("hello");
    kr_str s3 = (kr_str)(intptr_t)("world");
    bool eq1 = kr_str_eq(s1, s2);
    bool eq2 = kr_str_eq(s1, s3);
    bool ne1 = kr_str_ne(s1, s2);
    bool ne2 = kr_str_ne(s1, s3);
    int64_t result = 0;
    if (eq1) {
    }
    else {
