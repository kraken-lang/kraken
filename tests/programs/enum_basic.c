...
void kr_main() {
    __auto_type c = Color_Red;
    __auto_type s = Status_Error;
    if (c == Color_Red) {
        kr_puts("Matched Red!");
    }
    else if (c == Color_Green) {
        kr_puts("Matched Green!");
    }
    else if (c == Color_Blue) {
        kr_puts("Matched Blue!");
    }
    if (s == Status_Ok) {
        kr_puts("Status is Ok");
    }
    else if (s == Status_Error) {
        kr_puts("Status is Error");
    }
    else if (s == Status_Pending) {
        kr_puts("Status is Pending");
    }
    __auto_type green = Color_Green;
    if (green == Color_Red) {
        kr_puts("Should not match Red");
    }
    else if (green == Color_Green) {
        kr_puts("Correctly matched Green!");
    }
    else if (green == Color_Blue) {
        kr_puts("Should not match Blue");
    }
    kr_puts("Enum test passed!");
}
