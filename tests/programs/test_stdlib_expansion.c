...
int64_t kr_main() {
    ...
    failures = _KR_ADD(failures, kr_test_trig_functions());
    failures = _KR_ADD(failures, kr_test_inverse_trig());
    failures = _KR_ADD(failures, kr_test_hyperbolic());
    failures = _KR_ADD(failures, kr_test_exponential_log());
    failures = _KR_ADD(failures, kr_test_power_root());
    failures = _KR_ADD(failures, kr_test_rounding());
    failures = _KR_ADD(failures, kr_test_remainder());
    failures = _KR_ADD(failures, kr_test_other_math());
    kr_puts("");
    kr_puts("=== Time Functions ===");
    failures = _KR_ADD(failures, kr_test_time_functions());
    failures = _KR_ADD(failures, kr_test_difftime());
    failures = _KR_ADD(failures, kr_test_strftime());
    kr_puts("");
    kr_puts("=== Memory Functions ===");
    failures = _KR_ADD(failures, kr_test_calloc());
    failures = _KR_ADD(failures, kr_test_aligned_alloc());
    kr_puts("");
