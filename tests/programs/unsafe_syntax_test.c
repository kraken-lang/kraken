...
int64_t kr_main() {
    ...
    failures = _KR_ADD(failures, kr_test_unsafe_block());
    failures = _KR_ADD(failures, kr_test_unsafe_function());
    failures = _KR_ADD(failures, kr_test_nested_unsafe());
    failures = _KR_ADD(failures, kr_test_unsafe_with_control_flow());
    failures = _KR_ADD(failures, kr_test_unsafe_with_loop());
    failures = _KR_ADD(failures, kr_test_unsafe_function_chain());
    failures = _KR_ADD(failures, kr_test_unsafe_with_return());
