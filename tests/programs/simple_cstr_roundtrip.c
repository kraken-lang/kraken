...
int64_t kr_main() {
    kr_str s = (kr_str)(intptr_t)("hello");
    uint8_t* p = (uint8_t*)(intptr_t)(kr_cstr(s));
    kr_str t = (kr_str)(intptr_t)(kr_from_cstr(p));
    return kr_strcmp((kr_str)(intptr_t)(s), (kr_str)(intptr_t)(t));
}
