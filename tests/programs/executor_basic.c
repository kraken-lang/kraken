...
int64_t kr_main() {
    uint8_t* exec = (uint8_t*)(intptr_t)(kr_executor_new());
    kr_printf("Executor created\n");
    kr_executor_run(exec);
    kr_executor_shutdown(exec);
    kr_printf("Executor shutdown complete\n");
    return 0;
}
