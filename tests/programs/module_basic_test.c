...
int64_t kr_main() {
    ...
    kr_puts(kr_str_concat("add: ", kr_fmt_int(sum)));
    int64_t prod = kr_multiply(5, 6);
    kr_puts(kr_str_concat("multiply: ", kr_fmt_int(prod)));
    Vec2 v = (Vec2){.x = 10, .y = 20};
    kr_puts(kr_str_concat("v.x: ", kr_fmt_int(v.x)));
    kr_puts(kr_str_concat("v.y: ", kr_fmt_int(v.y)));
    return 0;
}
