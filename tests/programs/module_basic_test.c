...
int64_t kr_multiply(int64_t a, int64_t b);
int64_t kr_main();
...
int64_t kr_main() {
    int64_t sum = kr_add(3, 4);
    kr_puts(kr_str_concat("add: ", kr_fmt_int((int64_t)(intptr_t)(sum))));
    int64_t prod = kr_multiply(5, 6);
    kr_puts(kr_str_concat("multiply: ", kr_fmt_int((int64_t)(intptr_t)(prod))));
    Vec2 v = (Vec2){.x = 10, .y = 20};
    kr_puts(kr_str_concat("v.x: ", kr_fmt_int((int64_t)(intptr_t)(v.x))));
    kr_puts(kr_str_concat("v.y: ", kr_fmt_int((int64_t)(intptr_t)(v.y))));
    return 0;
}
