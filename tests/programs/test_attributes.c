...
int64_t kr_exported_function(int64_t x);
int64_t kr_test_addition();
int64_t kr_main();
...
int64_t kr_test_addition() {
    int64_t result = kr_fast_add(2, 3);
    return result;
}

int64_t kr_main() {
    Point p = (Point){.x = 10, .y = 20};
    int64_t result = kr_fast_add(5, 10);
    int64_t exported = kr_exported_function(7);
    return _KR_ADD(_KR_ADD(result, exported), p.x);
}
