...
S3 kr_adv3(S3 s) {
    return (S3){.a = _KR_ADD(s.a, 1), .b = s.b, .c = s.c};
}

S4 kr_adv4(S4 s) {
    return (S4){.a = _KR_ADD(s.a, 1), .b = s.b, .c = s.c, .d = s.d};
}

S5 kr_adv5(S5 s) {
    return (S5){.a = _KR_ADD(s.a, 1), .b = s.b, .c = s.c, .d = s.d, .e = s.e};
}

S6 kr_adv6(S6 s) {
    return (S6){.a = _KR_ADD(s.a, 1), .b = s.b, .c = s.c, .d = s.d, .e = s.e, .f = s.f};
}

int64_t kr_main() {
    S3 s3 = (S3){.a = 0, .b = 10, .c = 20};
    s3 = kr_adv3(s3);
    kr_puts(kr_str_concat("S3 a=", kr_fmt_int((int64_t)(intptr_t)(s3.a))));
    kr_puts(kr_str_concat("S3 c=", kr_fmt_int((int64_t)(intptr_t)(s3.c))));
    S4 s4 = (S4){.a = 0, .b = 10, .c = 20, .d = 30};
    s4 = kr_adv4(s4);
    kr_puts(kr_str_concat("S4 a=", kr_fmt_int((int64_t)(intptr_t)(s4.a))));
    kr_puts(kr_str_concat("S4 d=", kr_fmt_int((int64_t)(intptr_t)(s4.d))));
    S5 s5 = (S5){.a = 0, .b = 10, .c = 20, .d = 30, .e = 40};
    s5 = kr_adv5(s5);
    kr_puts(kr_str_concat("S5 a=", kr_fmt_int((int64_t)(intptr_t)(s5.a))));
    kr_puts(kr_str_concat("S5 e=", kr_fmt_int((int64_t)(intptr_t)(s5.e))));
    S6 s6 = (S6){.a = 0, .b = 10, .c = 20, .d = 30, .e = 40, .f = 50};
    s6 = kr_adv6(s6);
    kr_puts(kr_str_concat("S6 a=", kr_fmt_int((int64_t)(intptr_t)(s6.a))));
    kr_puts(kr_str_concat("S6 f=", kr_fmt_int((int64_t)(intptr_t)(s6.f))));
    return 0;
}
