...
typedef KrTuple2 IntPair;
typedef KrTuple3 IntTriple;
...
static int64_t _kr_cl_125(void*, int64_t);
static int64_t _kr_cl_137(void*, int64_t, int64_t);
static int64_t _kr_cl_137(void* _env, int64_t a, int64_t b) {
    return _KR_ADD(a, b);
}

static int64_t _kr_cl_125(void* _env, int64_t x) {
    return x * 2;
}
...
typedef void* BinaryOp;
void kr_test_function_type_alias() {
    IntFunction double_val = _kr_cl_alloc((void*)_kr_cl_125, 0);
    BinaryOp add = _kr_cl_alloc((void*)_kr_cl_137, 0);
    __auto_type result1 = ((int64_t(*)(void*, int64_t))_KR_CL_FN(double_val))(_KR_CL_ENV(double_val), 21);
    __auto_type result2 = ((int64_t(*)(void*, int64_t, int64_t))_KR_CL_FN(add))(_KR_CL_ENV(add), 10, 32);
}
...
void kr_test_multiple_aliases() {
    ...
    Number b = 2;
    Count c = 3;
    __auto_type sum = _KR_ADD(_KR_ADD(a, b), c);
}
