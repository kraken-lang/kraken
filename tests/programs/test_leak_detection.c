...
int64_t kr_main() {
    ...
    kr_puts("");
    failures = _KR_ADD(failures, kr_test_malloc_free_tracking());
    failures = _KR_ADD(failures, kr_test_calloc_tracking());
    failures = _KR_ADD(failures, kr_test_realloc_tracking());
    failures = _KR_ADD(failures, kr_test_allocation_stats());
    kr_puts("");
    kr_puts("Allocation statistics:");
    kr_kraken_print_allocation_stats();
    kr_puts("");
    failures = _KR_ADD(failures, kr_test_intentional_leak());
    kr_puts("");
