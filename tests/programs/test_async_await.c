...
int64_t kr_fetch_data();
int64_t kr_process_data();
int64_t kr_complex_async();
void kr_main();
...
int64_t kr_process_data() {
    __auto_type data = ((int64_t)(intptr_t)kr_fetch_data());
    return _KR_ADD(data, 10);
}

int64_t kr_complex_async() {
    __auto_type a = ((int64_t)(intptr_t)kr_fetch_data());
    __auto_type b = ((int64_t)(intptr_t)kr_process_data());
    return _KR_ADD(a, b);
}

void kr_main() {
    kr_println("Async/await test");
}
