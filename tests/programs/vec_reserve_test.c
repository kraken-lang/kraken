...
void kr_main() {
    ...
    kr_assert_eq(kr_vec_int_capacity(v), 4);
    kr_vec_int_reserve(v, 100);
    kr_assert_eq(kr_vec_int_capacity(v), 100);
    kr_assert_eq(kr_vec_int_len(v), 0);
    kr_vec_int_push(v, 1);
    kr_vec_int_push(v, 2);
    kr_vec_int_push(v, 3);
    kr_assert_eq(kr_vec_int_len(v), 3);
    kr_assert_eq(kr_vec_int_capacity(v), 100);
    kr_vec_int_shrink_to_fit(v);
    kr_assert_eq(kr_vec_int_capacity(v), 3);
    kr_assert_eq(kr_vec_int_len(v), 3);
    kr_assert_eq(kr_vec_int_get(v, 0), 1);
    kr_assert_eq(kr_vec_int_get(v, 1), 2);
    kr_assert_eq(kr_vec_int_get(v, 2), 3);
    kr_vec_int_reserve(v, 2);
    kr_assert_eq(kr_vec_int_capacity(v), 3);
    kr_vec_int_free(v);
    kr_puts("vec_int_reserve/shrink_to_fit tests passed!");
}
