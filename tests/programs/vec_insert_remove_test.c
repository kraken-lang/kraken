...
void kr_main() {
    __auto_type v = kr_vec_int_with_capacity(10);
    kr_vec_int_push(v, 10);
    kr_vec_int_push(v, 20);
    kr_vec_int_push(v, 30);
    kr_vec_int_insert(v, 1, 15);
    kr_assert_eq(kr_vec_int_len(v), 4);
    kr_assert_eq(kr_vec_int_get(v, 0), 10);
    kr_assert_eq(kr_vec_int_get(v, 1), 15);
    kr_assert_eq(kr_vec_int_get(v, 2), 20);
    kr_assert_eq(kr_vec_int_get(v, 3), 30);
    __auto_type removed = kr_vec_int_remove(v, 2);
    kr_assert_eq(removed, 20);
    kr_assert_eq(kr_vec_int_len(v), 3);
    kr_assert_eq(kr_vec_int_get(v, 0), 10);
    kr_assert_eq(kr_vec_int_get(v, 1), 15);
    kr_assert_eq(kr_vec_int_get(v, 2), 30);
    kr_vec_int_insert(v, 0, 5);
    kr_assert_eq(kr_vec_int_get(v, 0), 5);
    kr_assert_eq(kr_vec_int_get(v, 1), 10);
    __auto_type first = kr_vec_int_remove(v, 0);
    kr_assert_eq(first, 5);
    kr_assert_eq(kr_vec_int_get(v, 0), 10);
    kr_vec_int_free(v);
    kr_puts("vec_int_insert/remove tests passed!");
}
