...
This specification corresponds to Kraken **v0.9.3**. Language changes are governed by semantic versioning: breaking changes increment the minor version during the 0.x series and the major version at 1.0+.
